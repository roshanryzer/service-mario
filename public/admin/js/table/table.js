...
/***/ "./resources/admin/js/scripts/tables/table.js":
/*!****************************************************!*\
  !*** ./resources/admin/js/scripts/tables/table.js ***!
  \****************************************************/
...
(function ($, DataTable) {
  ...
  DataTable.ext.buttons.excel = {
    ...
    text: function text(dt) {
      return '<i class="fas fa-file-excel"></i> ' + dt.i18n('buttons.excel', RoshanVariables.languages.tables.excel);
    },
  ...
  DataTable.ext.buttons["export"] = {
    ...
    text: function text(dt) {
      return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', RoshanVariables.languages.tables["export"]) + '&nbsp;<span class="caret"/>';
    },
  ...
  DataTable.ext.buttons.csv = {
    ...
    text: function text(dt) {
      return '<i class="fas fa-file-excel"></i> ' + dt.i18n('buttons.csv', RoshanVariables.languages.tables.csv);
    },
    action: function action(e, dt) {
  ...
  DataTable.ext.buttons.print = {
    ...
    text: function text(dt) {
      return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', RoshanVariables.languages.tables.print);
    },
    action: function action(e, dt) {
  ...
  DataTable.ext.buttons.reset = {
    ...
    text: function text(dt) {
      return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', RoshanVariables.languages.tables.reset);
    },
  ...
  DataTable.ext.buttons.reload = {
    ...
    text: function text(dt) {
      return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', RoshanVariables.languages.tables.reload);
    },
    action: function action(e, dt) {
      dt.draw(false);
    }
    ...
    _createClass(TableManagement, [{
      ...
      value: function handleActionsRow() {
        ...
        $(document).on('click', '.delete-many-entry-trigger', function (event) {
          ...
          if (ids.length === 0) {
            Roshan.showNotice('error', 'Please select at least one record to perform this action!');
            return false;
          }
...
/***/ 8:
/*!**********************************************************!*\
  !*** multi ./resources/admin/js/scripts/tables/table.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\service-mario\resources\admin\js\scripts\tables\table.js */"./resources/admin/js/scripts/tables/table.js");
