...
/***/ "./resources/admin/js/media/App/Config/ExternalServiceConfig.js":
/*!**********************************************************************!*\
  !*** ./resources/admin/js/media/App/Config/ExternalServiceConfig.js ***!
  \**********************************************************************/
...
/***/ "./resources/admin/js/media/App/Config/MediaConfig.js":
/*!************************************************************!*\
  !*** ./resources/admin/js/media/App/Config/MediaConfig.js ***!
  \************************************************************/
...
var defaultConfig = {
  ...
  actions_list: {
    ...
    file: [{
      ...
      action: 'copy_link',
      order: 0,
      "class": 'rs-action-copy-link'
    }, {
      icon: 'far fa-edit',
      name: 'Rename',
      action: 'rename',
      order: 1,
      "class": 'rs-action-rename'
    }, {
      icon: 'fa fa-copy',
      name: 'Make a copy',
      action: 'make_copy',
      order: 2,
      "class": 'rs-action-make-copy'
    }],
    user: [{
      icon: 'fa fa-star',
      name: 'Favorite',
    ...
    other: [{
      ...
      action: 'download',
      order: 0,
      "class": 'rs-action-download'
    }, {
      icon: 'fa fa-trash',
      name: 'Move to trash',
      action: 'trash',
      order: 1,
      "class": 'rs-action-trash'
    }, {
      icon: 'fa fa-eraser',
      name: 'Delete permanently',
      action: 'delete',
      order: 2,
      "class": 'rs-action-delete'
    }, {
      icon: 'fa fa-undo',
      name: 'Restore',
      action: 'restore',
      order: 3,
      "class": 'rs-action-restore'
    }]
  },
...
/***/ "./resources/admin/js/media/App/Externals/ExternalServices.js":
/*!********************************************************************!*\
  !*** ./resources/admin/js/media/App/Externals/ExternalServices.js ***!
  \********************************************************************/
...
/* harmony import */ var _Youtube__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Youtube */ "./resources/admin/js/media/App/Externals/Youtube.js");
...
/***/ "./resources/admin/js/media/App/Externals/Youtube.js":
/*!***********************************************************!*\
  !*** ./resources/admin/js/media/App/Externals/Youtube.js ***!
  \***********************************************************/
...
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
/* harmony import */ var _Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Config/ExternalServiceConfig */ "./resources/admin/js/media/App/Config/ExternalServiceConfig.js");
/* harmony import */ var _Services_MediaService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MediaService */ "./resources/admin/js/media/App/Services/MediaService.js");
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Services/MessageService */ "./resources/admin/js/media/App/Services/MessageService.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Youtube = /*#__PURE__*/function () {
  function Youtube() {
    ...
    this.setMessage(RS_MEDIA_CONFIG.translations.add_from.youtube.original_msg);
    this.$modal.on('hidden.bs.modal', function () {
      _self.setMessage(RS_MEDIA_CONFIG.translations.add_from.youtube.original_msg);
    });
    this.$body.off('click', '#modal_add_from_youtube .rs-btn-add-youtube-url').on('click', '#modal_add_from_youtube .rs-btn-add-youtube-url', function (event) {
      event.preventDefault();

      _self.checkYouTubeVideo($(event.currentTarget).closest('#modal_add_from_youtube').find('.rs-youtube-url'));
    });
  }
    ...
    value: function checkYouTubeVideo($input) {
      ...
      if (!Youtube.validateYouTubeLink($input.val()) || !_Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__["ExternalServiceConfig"].youtube.api_key) {
        if (_Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__["ExternalServiceConfig"].youtube.api_key) {
          _self.setMessage(RS_MEDIA_CONFIG.translations.add_from.youtube.invalid_url_msg);
        } else {
          _self.setMessage(RS_MEDIA_CONFIG.translations.add_from.youtube.no_api_key_msg);
        }
      } else {
        ...
        $.ajax({
          ...
          error: function error() {
            _self.setMessage(RS_MEDIA_CONFIG.translations.add_from.youtube.error_msg);
          }
        });
      }
      ...
      function singleVideoCallback(data, url) {
        $.ajax({
          url: RS_MEDIA_URL.add_external_service,
          type: 'POST',
          dataType: 'json',
          data: {
            type: 'youtube',
          ...
          success: function success(res) {
            if (res.error) {
              _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__["MessageService"].showMessage('error', res.message, RS_MEDIA_CONFIG.translations.message.error_header);
            } else {
              _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__["MessageService"].showMessage('success', res.message, RS_MEDIA_CONFIG.translations.message.success_header);
...
/***/ "./resources/admin/js/media/App/Helpers/Helpers.js":
/*!*********************************************************!*\
  !*** ./resources/admin/js/media/App/Helpers/Helpers.js ***!
  \*********************************************************/
...
/* harmony import */ var _Config_MediaConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Config/MediaConfig */ "./resources/admin/js/media/App/Config/MediaConfig.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Helpers = /*#__PURE__*/function () {
  ...
  _createClass(Helpers, null, [{
    ...
    value: function asset(url) {
      ...
      var baseUrl = RS_MEDIA_URL.base_url.substr(-1, 1) !== '/' ? RS_MEDIA_URL.base_url + '/' : RS_MEDIA_URL.base_url;
    ...
    value: function showAjaxLoading() {
      var $element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $('.rs-media-main');
      $element.addClass('on-loading').append($('#rs_media_loading').html());
    }
  }, {
    key: "hideAjaxLoading",
    ...
    value: function isOnAjaxLoading() {
      var $element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $('.rs-media-items');
    ...
    value: function getRequestParams() {
      if (window.rsMedia.options && window.rsMedia.options.open_in === 'modal') {
        return $.extend(true, _Config_MediaConfig__WEBPACK_IMPORTED_MODULE_0__["MediaConfig"].request_params, window.rsMedia.options || {});
      }
    ...
    value: function setSelectedFile($file_id) {
      if (typeof window.rsMedia.options !== 'undefined') {
        window.rsMedia.options.selected_file_id = $file_id;
      } else {
    ...
    value: function isUseInModal() {
      return Helpers.getUrlParam('media-action') === 'select-files' || window.rsMedia && window.rsMedia.options && window.rsMedia.options.open_in === 'modal';
    }
  }, {
    key: "resetPagination",
    value: function resetPagination() {
      RS_MEDIA_CONFIG.pagination = {
        paged: 1,
        posts_per_page: 40,
...
/***/ "./resources/admin/js/media/App/Services/ActionsService.js":
/*!*****************************************************************!*\
  !*** ./resources/admin/js/media/App/Services/ActionsService.js ***!
  \*****************************************************************/
...
/* harmony import */ var _Config_MediaConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Config/MediaConfig */ "./resources/admin/js/media/App/Config/MediaConfig.js");
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MessageService */ "./resources/admin/js/media/App/Services/MessageService.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ActionsService = /*#__PURE__*/function () {
  ...
  _createClass(ActionsService, null, [{
    ...
    value: function handleDropdown() {
      ...
      if (selected > 0) {
        $('.rs-dropdown-actions').removeClass('disabled');
      } else {
        $('.rs-dropdown-actions').addClass('disabled');
      }
    }
  }, {
    key: "handlePreview",
    ...
    value: function handleCopyLink() {
      ...
      var $clipboardTemp = $('.js-rs-clipboard-temp');
      $clipboardTemp.data('clipboard-text', links);
      new Clipboard('.js-rs-clipboard-temp', {
        text: function text() {
          return links;
        }
      });
      _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('success', RS_MEDIA_CONFIG.translations.clipboard.success, RS_MEDIA_CONFIG.translations.message.success_header);
    ...
    value: function handleGlobalAction(type, callback) {
      ...
      switch (type) {
        case 'rename':
          $('#modal_rename_items').modal('show').find('form.rs-form').data('action', type);
          break;
        ...
        case 'trash':
          $('#modal_trash_items').modal('show').find('form.rs-form').data('action', type);
          break;

        case 'delete':
          $('#modal_delete_items').modal('show').find('form.rs-form').data('action', type);
          break;

        case 'empty_trash':
          $('#modal_empty_trash').modal('show').find('form.rs-form').data('action', type);
          break;

        case 'download':
          var downloadLink = RS_MEDIA_URL.download;
          var count = 0;
          ...
          if (downloadLink !== RS_MEDIA_URL.download) {
            window.open(downloadLink, '_blank');
          } else {
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('error', RS_MEDIA_CONFIG.translations.download.error, RS_MEDIA_CONFIG.translations.message.error_header);
          }
    ...
    value: function processAction(data) {
      ...
      $.ajax({
        url: RS_MEDIA_URL.global_actions,
        type: 'POST',
        data: data,
        dataType: 'json',
        ...
        success: function success(res) {
          ...
          if (!res.error) {
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('success', res.message, RS_MEDIA_CONFIG.translations.message.success_header);
          } else {
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('error', res.message, RS_MEDIA_CONFIG.translations.message.error_header);
          }
    ...
    value: function renderActions() {
      ...
      var $dropdownActions = $('.rs-dropdown-actions .dropdown-menu');
      ...
      if (hasFolderSelected) {
        ...
        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'folders.create')) {
          actionsList.file = _.reject(actionsList.file, function (item) {
            return item.action === 'make_copy';
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'folders.edit')) {
          actionsList.file = _.reject(actionsList.file, function (item) {
        ...
        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'folders.trash')) {
          actionsList.other = _.reject(actionsList.other, function (item) {
            return _.includes(['trash', 'restore'], item.action);
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'folders.delete')) {
          actionsList.other = _.reject(actionsList.other, function (item) {
            return _.includes(['delete'], item.action);
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'folders.favorite')) {
          actionsList.other = _.reject(actionsList.other, function (item) {
      ...
      if (selectedFiles.length > 0) {
        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'files.create')) {
          actionsList.file = _.reject(actionsList.file, function (item) {
            return item.action === 'make_copy';
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'files.edit')) {
          actionsList.file = _.reject(actionsList.file, function (item) {
            return _.includes(['rename'], item.action);
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'files.trash')) {
          actionsList.other = _.reject(actionsList.other, function (item) {
            return _.includes(['trash', 'restore'], item.action);
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'files.delete')) {
          actionsList.other = _.reject(actionsList.other, function (item) {
            return _.includes(['delete'], item.action);
          });
        }

        if (!_.includes(RS_MEDIA_CONFIG.permissions, 'files.favorite')) {
          actionsList.other = _.reject(actionsList.other, function (item) {
            return _.includes(['favorite', 'remove_favorite'], item.action);
          });
        }
      ...
      _.each(actionsList, function (action, key) {
        _.each(action, function (item, index) {
          ...
          if (!is_break) {
            var template = ACTION_TEMPLATE.replace(/__action__/gi, item.action || '').replace(/__icon__/gi, item.icon || '').replace(/__name__/gi, RS_MEDIA_CONFIG.translations.actions_list[key][item.action] || item.name);
...
/***/ "./resources/admin/js/media/App/Services/ContextMenuService.js":
/*!*********************************************************************!*\
  !*** ./resources/admin/js/media/App/Services/ContextMenuService.js ***!
  \*********************************************************************/
...
/* harmony import */ var _ActionsService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ActionsService */ "./resources/admin/js/media/App/Services/ActionsService.js");
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
      ...
      _.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getConfigs().actions_list, function (actionGroup, key) {
        _.each(actionGroup, function (value) {
          items[value.action] = {
            name: value.name,
            icon: function icon(opt, $itemElement, itemKey, item) {
              $itemElement.html('<i class="' + value.icon + '" aria-hidden="true"></i> ' + (RS_MEDIA_CONFIG.translations.actions_list[key][value.action] || item.name));
              return 'context-menu-icon-updated';
            },
            callback: function callback() {
...
/***/ "./resources/admin/js/media/App/Services/FolderService.js":
/*!****************************************************************!*\
  !*** ./resources/admin/js/media/App/Services/FolderService.js ***!
  \****************************************************************/
...
/* harmony import */ var _Config_MediaConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Config/MediaConfig */ "./resources/admin/js/media/App/Config/MediaConfig.js");
/* harmony import */ var _MediaService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MediaService */ "./resources/admin/js/media/App/Services/MediaService.js");
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MessageService */ "./resources/admin/js/media/App/Services/MessageService.js");
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var FolderService = /*#__PURE__*/function () {
  ...
  _createClass(FolderService, [{
    ...
    value: function create(folderName) {
      ...
      $.ajax({
        url: RS_MEDIA_URL.create_folder,
        type: 'POST',
        data: {
...
/***/ "./resources/admin/js/media/App/Services/MediaService.js":
/*!***************************************************************!*\
  !*** ./resources/admin/js/media/App/Services/MediaService.js ***!
  \***************************************************************/
...
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MessageService */ "./resources/admin/js/media/App/Services/MessageService.js");
/* harmony import */ var _Services_ActionsService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Services/ActionsService */ "./resources/admin/js/media/App/Services/ActionsService.js");
/* harmony import */ var _Services_ContextMenuService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Services/ContextMenuService */ "./resources/admin/js/media/App/Services/ContextMenuService.js");
/* harmony import */ var _Views_MediaList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Views/MediaList */ "./resources/admin/js/media/App/Views/MediaList.js");
/* harmony import */ var _Views_MediaDetails__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Views/MediaDetails */ "./resources/admin/js/media/App/Views/MediaDetails.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var MediaService = /*#__PURE__*/function () {
  ...
  _createClass(MediaService, [{
    ...
    value: function getMedia() {
      ...
      if (typeof RS_MEDIA_CONFIG.pagination != 'undefined') {
        if (RS_MEDIA_CONFIG.pagination.in_process_get_media) {
          return;
        } else {
          RS_MEDIA_CONFIG.pagination.in_process_get_media = true;
        }
      }
      ...
      if (typeof RS_MEDIA_CONFIG.pagination != 'undefined') {
        params.paged = RS_MEDIA_CONFIG.pagination.paged;
        params.posts_per_page = RS_MEDIA_CONFIG.pagination.posts_per_page;
      }

      $.ajax({
        url: RS_MEDIA_URL.get_media,
        type: 'GET',
        data: params,
        dataType: 'json',
        beforeSend: function beforeSend() {
        ...
        success: function success(res) {
          ...
          if (typeof RS_MEDIA_CONFIG.pagination != 'undefined') {
            if (typeof RS_MEDIA_CONFIG.pagination.paged != 'undefined') {
              RS_MEDIA_CONFIG.pagination.paged += 1;
            }

            if (typeof RS_MEDIA_CONFIG.pagination.in_process_get_media != 'undefined') {
              RS_MEDIA_CONFIG.pagination.in_process_get_media = false;
            }

            if (typeof RS_MEDIA_CONFIG.pagination.posts_per_page != 'undefined' && res.data.files.length < RS_MEDIA_CONFIG.pagination.posts_per_page && typeof RS_MEDIA_CONFIG.pagination.has_more != 'undefined') {
              RS_MEDIA_CONFIG.pagination.has_more = false;
            }
          }
        },
        complete: function complete() {
    ...
    value: function fetchQuota() {
      $.ajax({
        url: RS_MEDIA_URL.get_quota,
        type: 'GET',
        dataType: 'json',
        success: function success(res) {
          var data = res.data;
          $('.rs-media-aside-bottom .used-analytics span').html(data.used + ' / ' + data.quota);
          $('.rs-media-aside-bottom .progress-bar').css({
            width: data.percent + '%'
          });
        },
        error: function error(data) {
    ...
    value: function renderBreadcrumbs(breadcrumbItems) {
      ...
      var $breadcrumbContainer = $('.rs-media-breadcrumb .breadcrumb');
      ...
      $('.rs-media-container').attr('data-breadcrumb-count', _.size(breadcrumbItems));
    }
  }], [{
    key: "refreshFilter",
    value: function refreshFilter() {
      var $rvMediaContainer = $('.rs-media-container');
      var view_in = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().view_in;

      if (view_in !== 'all_media' && parseInt(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().folder_id) === 0) {
        $('.rs-media-actions .btn:not([data-type="refresh"]):not(label)').addClass('disabled');
        $rvMediaContainer.attr('data-allow-upload', 'false');
      } else {
        $('.rs-media-actions .btn:not([data-type="refresh"]):not(label)').removeClass('disabled');
        $rvMediaContainer.attr('data-allow-upload', 'true');
      }

      $('.rs-media-actions .btn.js-rs-media-change-filter-group').removeClass('disabled');
      var $empty_trash_btn = $('.rs-media-actions .btn[data-action="empty_trash"]');
...
/***/ "./resources/admin/js/media/App/Services/MessageService.js":
/*!*****************************************************************!*\
  !*** ./resources/admin/js/media/App/Services/MessageService.js ***!
  \*****************************************************************/
...
var MessageService = /*#__PURE__*/function () {
  ...
  _createClass(MessageService, null, [{
    ...
    value: function showMessage(type, message) {
      ...
      switch (type) {
        case 'error':
          messageHeader = RS_MEDIA_CONFIG.translations.message.error_header;
          break;

        case 'success':
          messageHeader = RS_MEDIA_CONFIG.translations.message.success_header;
          break;
      }
...
/***/ "./resources/admin/js/media/App/Services/UploadService.js":
/*!****************************************************************!*\
  !*** ./resources/admin/js/media/App/Services/UploadService.js ***!
  \****************************************************************/
...
/* harmony import */ var _Services_MediaService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Services/MediaService */ "./resources/admin/js/media/App/Services/MediaService.js");
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var UploadService = /*#__PURE__*/function () {
  function UploadService() {
    ...
    this.$body = $('body');
    this.dropZone = null;
    this.uploadUrl = RS_MEDIA_URL.upload_file;
    this.uploadProgressBox = $('.rs-upload-progress');
    this.uploadProgressContainer = $('.rs-upload-progress .rs-upload-progress-table');
  ...
  _createClass(UploadService, [{
    key: "init",
    value: function init() {
      if (_.includes(RS_MEDIA_CONFIG.permissions, 'files.create') && $('.rs-media-items').length > 0) {
        this.setupDropZone();
      }
    ...
    value: function setupDropZone() {
      ...
      _self.dropZone = new Dropzone(document.querySelector('.rs-media-items'), {
        url: _self.uploadUrl,
      ...
      _self.dropZone.on('queuecomplete', function () {
        ...
        if (_self.totalError === 0) {
          setTimeout(function () {
            $('.rs-upload-progress .close-pane').trigger('click');
          }, 5000);
        }
      });
    }
    ...
    value: function handleEvents() {
      ...
      _self.$body.off('click', '.rs-upload-progress .close-pane').on('click', '.rs-upload-progress .close-pane', function (event) {
        event.preventDefault();
        $('.rs-upload-progress').addClass('hide-the-pane');
        _self.totalError = 0;
        setTimeout(function () {
          $('.rs-upload-progress li').remove();
          _self.totalQueued = 1;
        }, 300);
      });
    }
...
/***/ "./resources/admin/js/media/App/Views/MediaDetails.js":
/*!************************************************************!*\
  !*** ./resources/admin/js/media/App/Views/MediaDetails.js ***!
  \************************************************************/
...
var MediaDetails = /*#__PURE__*/function () {
  function MediaDetails() {
    ...
    this.$detailsWrapper = $('.rs-media-main .rs-media-details');
    this.descriptionItemTemplate = '<div class="rs-media-name"><p>__title__</p>__url__</div>';
  ...
  _createClass(MediaDetails, [{
    ...
    value: function renderData(data) {
      ...
      _self.$detailsWrapper.find('.rs-media-thumbnail').html(thumb);

      _self.$detailsWrapper.find('.rs-media-description').html(description);
...
/***/ "./resources/admin/js/media/App/Views/MediaList.js":
/*!*********************************************************!*\
  !*** ./resources/admin/js/media/App/Views/MediaList.js ***!
  \*********************************************************/
...
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
/* harmony import */ var _Services_ActionsService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Services/ActionsService */ "./resources/admin/js/media/App/Services/ActionsService.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var MediaList = /*#__PURE__*/function () {
  function MediaList() {
    ...
    this.group = {};
    this.group.list = $('#rs_media_items_list').html();
    this.group.tiles = $('#rs_media_items_tiles').html();
    this.item = {};
    this.item.list = $('#rs_media_items_list_element').html();
    this.item.tiles = $('#rs_media_items_tiles_element').html();
    this.$groupContainer = $('.rs-media-items');
  }
  ...
  _createClass(MediaList, [{
    ...
    value: function renderData(data) {
      ...
      template = template.replace(/__noItemIcon__/gi, RS_MEDIA_CONFIG.translations.no_item[view_in].icon || '').replace(/__noItemTitle__/gi, RS_MEDIA_CONFIG.translations.no_item[view_in].title || '').replace(/__noItemMessage__/gi, RS_MEDIA_CONFIG.translations.no_item[view_in].message || '');
      var $result = $(template);
      var $itemsWrapper = $result.find('ul');

      if (load_more_file && this.$groupContainer.find('.rs-media-grid ul').length > 0) {
        $itemsWrapper = this.$groupContainer.find('.rs-media-grid ul');
      }

      if (_.size(data.folders) > 0 || _.size(data.files) > 0 || load_more_file) {
        $('.rs-media-items').addClass('has-items');
      } else {
        $('.rs-media-items').removeClass('has-items');
      }
      ...
      if (load_more_file && this.$groupContainer.find('.rs-media-grid ul').length > 0) {} else {
...
/***/ "./resources/admin/js/media/integrate.js":
/*!***********************************************!*\
  !*** ./resources/admin/js/media/integrate.js ***!
  \***********************************************/
...
/* harmony import */ var _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App/Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
/* harmony import */ var _App_Config_MediaConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App/Config/MediaConfig */ "./resources/admin/js/media/App/Config/MediaConfig.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
  ...
  _createClass(EditorService, null, [{
    ...
    value: function editorSelectFile(selectedFiles) {
      ...
      if (window.opener && is_ckeditor) {
        ...
        window.opener.CKEDITOR.tools.callFunction(_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__["Helpers"].getUrlParam('CKEditorFuncNum'), firstItem.url);
...
var rsMedia = function rsMedia(selector, options) {
  _classCallCheck(this, rsMedia);

  window.rsMedia = window.rsMedia || {};
  var $body = $('body');
  var defaultOptions = {
    multiple: true,
    type: '*',
  ...
  var clickCallback = function clickCallback(event) {
    ...
    $('#rs_media_modal').modal();
    window.rsMedia.options = options;
    window.rsMedia.options.open_in = 'modal';
    window.rsMedia.$el = $current;
    ...
    var ele_options = window.rsMedia.$el.data('rs-media');

    if (typeof ele_options !== 'undefined' && ele_options.length > 0) {
      ele_options = ele_options[0];
      window.rsMedia.options = $.extend(true, window.rsMedia.options, ele_options || {});

      if (typeof ele_options.selected_file_id !== 'undefined') {
        window.rsMedia.options.is_popup = true;
      } else if (typeof window.rsMedia.options.is_popup !== 'undefined') {
        window.rsMedia.options.is_popup = undefined;
      }
    }

    if ($('#rs_media_body .rs-media-container').length === 0) {
      $('#rs_media_body').load(RS_MEDIA_URL.popup, function (data) {
        if (data.error) {
          alert(data.message);
        }

        $('#rs_media_body').removeClass('media-modal-loading').closest('.modal-content').removeClass('bb-loading');
        $(document).find('.rs-media-container .js-change-action[data-type=refresh]').trigger('click');
      });
    } else {
      $(document).find('.rs-media-container .js-change-action[data-type=refresh]').trigger('click');
    }
...
window.RvMediaStandAlone = rsMedia;
...
$.fn.rsMedia = function (options) {
  ...
  _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__["Helpers"].storeConfig();
  new rsMedia($selector, options);
};

/***/ }),

/***/ "./resources/admin/js/media/media.js":
/*!*******************************************!*\
  !*** ./resources/admin/js/media/media.js ***!
  \*******************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _App_Config_MediaConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App/Config/MediaConfig */ "./resources/admin/js/media/App/Config/MediaConfig.js");
/* harmony import */ var _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App/Helpers/Helpers */ "./resources/admin/js/media/App/Helpers/Helpers.js");
/* harmony import */ var _App_Services_MediaService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./App/Services/MediaService */ "./resources/admin/js/media/App/Services/MediaService.js");
/* harmony import */ var _App_Services_FolderService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./App/Services/FolderService */ "./resources/admin/js/media/App/Services/FolderService.js");
/* harmony import */ var _App_Services_UploadService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./App/Services/UploadService */ "./resources/admin/js/media/App/Services/UploadService.js");
/* harmony import */ var _App_Services_ActionsService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./App/Services/ActionsService */ "./resources/admin/js/media/App/Services/ActionsService.js");
/* harmony import */ var _App_Externals_ExternalServices__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./App/Externals/ExternalServices */ "./resources/admin/js/media/App/Externals/ExternalServices.js");
/* harmony import */ var _integrate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./integrate */ "./resources/admin/js/media/integrate.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var MediaManagement = /*#__PURE__*/function () {
  ...
  _createClass(MediaManagement, [{
    ...
    value: function setupLayout() {
       ...
       * Sidebar
       */
      var $current_filter = $('.js-rs-media-change-filter[data-type="filter"][data-value="' + _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().filter + '"]');
      $current_filter.closest('li').addClass('active').closest('.dropdown').find('.js-rs-media-filter-current').html('(' + $current_filter.html() + ')');
      var $current_view_in = $('.js-rs-media-change-filter[data-type="view_in"][data-value="' + _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().view_in + '"]');
      $current_view_in.closest('li').addClass('active').closest('.dropdown').find('.js-rs-media-filter-current').html('(' + $current_view_in.html() + ')');

      if (_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].isUseInModal()) {
        $('.rs-media-footer').removeClass('hidden');
      }
      /**
       * Sort
       */
      ...
      $('.js-rs-media-change-filter[data-type="sort_by"][data-value="' + _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().sort_by + '"]').closest('li').addClass('active');
      /**
       * Details pane
       */
      ...
      setTimeout(function () {
        $('.rs-media-details').removeClass('hidden');
      }, 300);
      ...
      _self.$body.off('click', '.js-media-list-title').on('click', '.js-media-list-title', function (event) {
        ...
        if (shift_key) {
          ...
          if (firstItem) {
            ...
            $('.rs-media-items li').each(function (index, el) {
          ...
          if (!ctrl_key && !meta_key) {
            $current.closest('.rs-media-items').find('input[type=checkbox]').prop('checked', false);
          }
        }
        ...
        event.preventDefault();
        var count = $('.rs-media-breadcrumb .breadcrumb li').length;
        $('.rs-media-breadcrumb .breadcrumb li:nth-child(' + (count - 1) + ') a').trigger('click');
      }).on('contextmenu', '.js-context-menu', function (event) {
        if (!$(event.currentTarget).find('input[type=checkbox]').is(':checked')) {
          $(event.currentTarget).trigger('click');
        }
      }).on('click contextmenu', '.rs-media-items', function (e) {
        if (!_.size(e.target.closest('.js-context-menu'))) {
          $('.rs-media-items input[type="checkbox"]').prop('checked', false);
          $('.rs-dropdown-actions').addClass('disabled');
    ...
    value: function changeViewType() {
      ...
      _self.$body.off('click', '.js-rs-media-change-view-type .btn').on('click', '.js-rs-media-change-view-type .btn', function (event) {
        event.preventDefault();
        var $current = $(event.currentTarget);
        ...
        $current.closest('.js-rs-media-change-view-type').find('.btn').removeClass('active');
      ...
      $('.js-rs-media-change-view-type .btn[data-type="' + _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().view_type + '"]').trigger('click');
    ...
    value: function changeFilter() {
      ...
      _self.$body.off('click', '.js-rs-media-change-filter').on('click', '.js-rs-media-change-filter', function (event) {
        event.preventDefault();
        ...
        if (!_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].isOnAjaxLoading()) {
          ...
          $current.closest('.dropdown').find('.js-rs-media-filter-current').html('(' + $current.html() + ')');
          _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].storeConfig();
    ...
    value: function handleActions() {
      ...
      _self.$body.off('click', '.rs-media-actions .js-change-action[data-type="refresh"]').on('click', '.rs-media-actions .js-change-action[data-type="refresh"]', function (event) {
        event.preventDefault();
        _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].resetPagination();
        var ele_options = typeof window.rsMedia.$el !== 'undefined' ? window.rsMedia.$el.data('rs-media') : undefined;
      ...
      }).off('click', '.rs-media-items li.no-items').on('click', '.rs-media-items li.no-items', function (event) {
        event.preventDefault();
        $('.rs-media-header .rs-media-top-header .rs-media-actions .js-dropzone-upload').trigger('click');
    ...
    value: function handleModals() {
      ...
      _self.$body.off('submit', '#modal_empty_trash .rs-form').on('submit', '#modal_empty_trash .rs-form', function (event) {
        event.preventDefault();
        var $form = $(event.currentTarget);
        _App_Services_ActionsService__WEBPACK_IMPORTED_MODULE_5__["ActionsService"].processAction({
          action: $form.data('action')
    ...
    value: function checkFileTypeSelect(selectedFiles) {
      if (typeof window.rsMedia.$el !== 'undefined') {
        var firstItem = _.first(selectedFiles);
    ...
    value: function bindIntegrateModalEvents() {
      ...
      $main_modal.off('click', '.js-insert-to-editor').on('click', '.js-insert-to-editor', function (event) {
        ...
        if (_.size(selectedFiles) > 0) {
          window.rsMedia.options.onSelectFiles(selectedFiles, window.rsMedia.$el);
    ...
    value: function scrollGetMore() {
      ...
      $('.rs-media-main .rs-media-items').bind('DOMMouseScroll mousewheel', function (e) {
        if (e.originalEvent.detail > 0 || e.originalEvent.wheelDelta < 0) {
          ...
          if ($load_more) {
            if (typeof RS_MEDIA_CONFIG.pagination != 'undefined' && RS_MEDIA_CONFIG.pagination.has_more) {
...
/***/ 2:
/*!*************************************************!*\
  !*** multi ./resources/admin/js/media/media.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\service-mario\resources\admin\js\media\media.js */"./resources/admin/js/media/media.js");
