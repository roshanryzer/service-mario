...
/***/ "./resources/admin/js/app_modules/form-validation.js":
/*!***********************************************************!*\
  !*** ./resources/admin/js/app_modules/form-validation.js ***!
  \***********************************************************/
/*! no static exports found */
...
function _strtotime(e, t) {
  function a(e, t, a) {
    var r,
        n = u[t];
    "undefined" != typeof n && (r = n - l.getDay(), 0 === r ? r = 7 * a : r > 0 && "last" === e ? r -= 7 : r < 0 && "next" === e && (r += 7), l.setDate(l.getDate() + r));
  }
  ...
  function r(e) {
    var t = e.split(" "),
        ...
        s = "ago" === t[2],
        o = ("last" === r ? -1 : 1) * (s ? -1 : 1);
    if (i && (o *= parseInt(r, 10)), d.hasOwnProperty(n) && !t[1].match(/^mon(day|\.)?$/i)) return l["set" + d[n]](l["get" + d[n]]() + o);
    if ("wee" === n) return l.setDate(l.getDate() + 7 * o);
    if ("next" === r || "last" === r) a(r, n, o);else if (!i) return !1;
    return !0;
  }
  ...
  var n,
      ...
      g = !1;
  if (!e) return g;
  if (e = e.replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " ").replace(/[\t\r\n]/g, "").toLowerCase(), i = e.match(/^(\d{1,4})([\-\.\/\:])(\d{1,2})([\-\.\/\:])(\d{1,4})(?:\s(\d{1,2}):(\d{2})?:?(\d{2})?)?(?:\s([A-Z]+)?)?$/), i && i[2] === i[4]) if (i[1] > 1901) switch (i[2]) {
    case "-":
      return i[3] > 12 || i[5] > 31 ? g : new Date(i[1], parseInt(i[3], 10) - 1, i[5], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;
    ...
    case "-":
      return i[3] > 12 || i[1] > 31 ? g : new Date(i[5], parseInt(i[3], 10) - 1, i[1], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;

    case ".":
      return i[3] > 12 || i[1] > 31 ? g : new Date(i[5], parseInt(i[3], 10) - 1, i[1], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;

    case "/":
      return i[1] > 12 || i[3] > 31 ? g : new Date(i[5], parseInt(i[1], 10) - 1, i[3], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3;
  } else switch (i[2]) {
    case "-":
      return i[3] > 12 || i[5] > 31 || i[1] < 70 && i[1] > 38 ? g : (o = i[1] >= 0 && i[1] <= 38 ? +i[1] + 2e3 : i[1], new Date(o, parseInt(i[3], 10) - 1, i[5], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3);

    case ".":
      return i[5] >= 70 ? i[3] > 12 || i[1] > 31 ? g : new Date(i[5], parseInt(i[3], 10) - 1, i[1], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3 : i[5] < 60 && !i[6] ? i[1] > 23 || i[3] > 59 ? g : (s = new Date(), new Date(s.getFullYear(), s.getMonth(), s.getDate(), i[1] || 0, i[3] || 0, i[5] || 0, i[9] || 0) / 1e3) : g;

    case "/":
      return i[1] > 12 || i[3] > 31 || i[5] < 70 && i[5] > 38 ? g : (o = i[5] >= 0 && i[5] <= 38 ? +i[5] + 2e3 : i[5], new Date(o, parseInt(i[1], 10) - 1, i[3], i[6] || 0, i[7] || 0, i[8] || 0, i[9] || 0) / 1e3);

    case ":":
      return i[1] > 23 || i[3] > 59 || i[5] > 59 ? g : (s = new Date(), new Date(s.getFullYear(), s.getMonth(), s.getDate(), i[1] || 0, i[3] || 0, i[5] || 0) / 1e3);
  }
  ...
  if (l = t ? new Date(1e3 * t) : new Date(), u = {
    ...
    min: "Minutes",
    sec: "Seconds"
  }, c = "(years?|months?|weeks?|days?|hours?|minutes?|min|seconds?|sec|sunday|sun\\.?|monday|mon\\.?|tuesday|tue\\.?|wednesday|wed\\.?|thursday|thu\\.?|friday|fri\\.?|saturday|sat\\.?)", m = "([+-]?\\d+\\s" + c + "|(last|next)\\s" + c + ")(\\sago)?", i = e.match(new RegExp(m, "gi")), !i) return g;
  ...
  e.extend(e.fn, {
    ...
    defaults: {
      ...
      onkeyup: function onkeyup(t, a) {
        ...
        9 === a.which && "" === this.elementValue(t) || e.inArray(a.keyCode, r) !== -1 || (t.name in this.submitted || t === this.lastElement) && this.element(t);
      },
    ...
    prototype: {
      ...
      element: function element(t) {
        var a = this.clean(t),
            ...
            n = !0;
        return this.lastElement = r, void 0 === r ? delete this.invalid[a.name] : (this.prepareElement(r), this.currentElements = e(r), n = this.check(r) !== !1, n ? delete this.invalid[r.name] : this.invalid[r.name] = !0), e(t).attr("aria-invalid", !n), this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), n;
      },
      ...
      resetForm: function resetForm() {
        ...
        var t,
            a = this.elements().removeData("previousValue").removeAttr("aria-invalid");
        if (this.settings.unhighlight) for (t = 0; a[t]; t++) {
      ...
      elementValue: function elementValue(t) {
        var a,
            r = e(t),
            n = t.type;
        return "radio" === n || "checkbox" === n ? this.findByName(t.name).filter(":checked").val() : "number" === n && "undefined" != typeof t.validity ? !t.validity.badInput && r.val() : (a = r.val(), "string" == typeof a ? a.replace(/\r/g, "") : a);
      },
      ...
      formatAndAdd: function formatAndAdd(t, a) {
        var r = this.defaultMessage(t, a.method),
            n = /\$?\{(\d+)\}/g;
        "function" == typeof r ? r = r.call(this, a.parameters, t) : n.test(r) && (r = e.validator.format(r.replace(n, "{$1}"), a.parameters)), this.errorList.push({
          message: r,
          element: t,
          method: a.method
    ...
    addClassRules: function addClassRules(t, a) {
    ...
    normalizeRules: function normalizeRules(t, a) {
      return e.each(t, function (r, n) {
        ...
        if (n.param || n.depends) {
          ...
          i ? t[r] = void 0 === n.param || n.param : delete t[r];
        }
    ...
    methods: {
      required: function required(t, a, r) {
      ...
      remote: function remote(t, a, r) {
        ...
        return this.settings.messages[a.name] || (this.settings.messages[a.name] = {}), s.originalMessage = this.settings.messages[a.name].remote, this.settings.messages[a.name].remote = s.message, r = "string" == typeof r && {
          url: r
        } || r, s.old === t ? s.valid : (s.old = t, n = this, this.startRequest(a), i = {}, i[a.name] = t, e.ajax(e.extend(!0, {
          mode: "abort",
          ...
          success: function success(r) {
            var i,
                ...
                l,
                u = r === !0 || "true" === r;
            n.settings.messages[a.name].remote = s.originalMessage, u ? (l = n.formSubmitted, n.prepareElement(a), n.formSubmitted = l, n.successList.push(a), delete n.invalid[a.name], n.showErrors()) : (i = {}, o = r || n.defaultMessage(a, "remote"), i[a.name] = s.message = e.isFunction(o) ? o(t) : o, n.invalid[a.name] = !0, n.showErrors(i)), s.valid = u, n.stopRequest(a, u);
          }
        }, r)), "pending");
      }
    }
...
!function () {
  ...
  i = 864e5, s = 3600, e = function e(_e, t) {
    ...
    getMonth: function getMonth(e) {
      var t,
          a = this;
      return t = r(e, a.dateSettings.monthsShort) + 1, 0 === t && (t = r(e, a.dateSettings.months) + 1), t;
    },
    parseDate: function parseDate(t, a) {
      ...
      if ("U" === a) return i = parseInt(t), i ? new Date(1e3 * i) : t;
      ...
      for (n = t.replace(m.separators, "\0").split("\0"), i = 0; i < n.length; i++) {
        switch (s = n[i], o = parseInt(s), r[i]) {
          ...
          case "F":
            if (isNaN(o)) {
              if (l = m.getMonth(s), !(l > 0)) return null;
              v.month = l;
            } else {
    ...
    guessDate: function guessDate(e, t) {
      ...
      for (n = 0; n < u.length; n++) {
        if (m = 2, s = u[n], o = parseInt(s.substr(0, 2)), isNaN(o)) return null;

        switch (n) {
          case 0:
            "m" === h[0] || "n" === h[0] ? c.setMonth(o - 1) : c.setDate(o);
            break;

          case 1:
            "m" === h[0] || "n" === h[0] ? c.setDate(o) : c.setMonth(o - 1);
            break;

          case 2:
            if (r = c.getFullYear(), a = s.length, m = a < 4 ? a : 4, r = parseInt(a < 4 ? r.toString().substr(0, 4 - a) + s : s.substr(0, 4)), !r) return null;
            c.setFullYear(r);
            break;
    ...
    parseFormat: function parseFormat(e, a) {
      ...
      return r = {
        ...
        W: function W() {
          ...
          return _t(1 + Math.round((e - a) / i / 7), 2);
        },
        F: function F() {
        ...
        o: function o() {
          var e = r.n(),
              t = r.W(),
              a = r.Y();
          return a + (12 === e && t < 9 ? 1 : 1 === e && t > 9 ? -1 : 0);
        },
        Y: function Y() {
        ...
        B: function B() {
          var e = a.getUTCHours() * s,
              ...
              n = a.getUTCSeconds();
          return _t(Math.floor((e + r + n + s) / 86.4) % 1e3, 3);
        },
        g: function g() {
          return r.G() % 12 || 12;
        },
        ...
        T: function T() {
          var e = (String(a).match(n.tzParts) || [""]).pop().replace(n.tzClip, "");
          return e || "UTC";
        },
        Z: function Z() {
    ...
    formatDate: function formatDate(e, t) {
      var a,
          ...
          l = "",
          u = "\\";
      if ("string" == typeof e && (e = o.parseDate(e, t), !e)) return null;
...
laravelValidation = {
  ...
  arrayRules: function arrayRules(e) {
    var t = {},
        ...
        r = a.arrayRulesCache;
    return e.name.indexOf("[") === -1 ? t : (e.name in r || (r[e.name] = {}), $.each(a.settings.rules, function (a, n) {
    ...
    $.validator.addMethod("laravelValidation", function (e, t, a) {
      ...
      return $.each(a, function (e, t) {
        ...
        var o = s[3] || laravelValidation.implicitRules.indexOf(s[0]) !== -1,
            l = s[0],
            u = s[2];
        return !o && r.optional(t) ? (n = "dependency-mismatch", !1) : (n = void 0 !== laravelValidation.methods[l] && laravelValidation.methods[l].call(r, e, t, s[1], function (a) {
          if (r.settings.messages[t.name].laravelValidationRemote = i.originalMessage, a) {
            var n = r.formSubmitted;
            r.prepareElement(t), r.formSubmitted = n, r.successList.push(t), delete r.invalid[t.name], r.showErrors();
          } else {
            var s = {};
            s[t.name] = i.message = $.isFunction(u) ? u(e) : u, r.invalid[t.name] = !0, r.showErrors(s);
          }
      ...
      this.settings.messages[t.name] || (this.settings.messages[t.name] = {}), d.originalMessage = this.settings.messages[t.name].laravelValidationRemote, this.settings.messages[t.name].laravelValidationRemote = d.message;
      var h = "string" == typeof h && {
        url: h
      } || h;
      if (laravelValidation.helpers.arrayEquals(d.old, e) || d.old === e) return d.valid;
      d.old = e, l = this, this.startRequest(t), u = $(l.currentForm).serializeArray(), u.push({
        name: "_jsvalidation",
        value: i
      }), u.push({
      ...
      return $(l.currentForm).find('input[name="_method"]').length && (c = $(l.currentForm).find('input[name="_method"]').val()), $.ajax($.extend(!0, {
        ...
        var n, i, s, o;
        if ("error" === r) o = !1, a = laravelValidation.helpers.parseErrorResponse(a);else {
          if ("success" !== r) return;
          o = a === !0 || "true" === a;
        }
  ...
  helpers: {
    ...
    fileinfo: function fileinfo(e, t) {
      var a = e.value;
      return t = "undefined" != typeof t ? t : 0, null !== e.files && "undefined" != typeof e.files[t] && {
        file: a,
    ...
    dependentElement: function dependentElement(e, t, a) {
      ...
      if (void 0 !== r[0] && e.settings.onfocusout) {
        var n = "blur";
        "SELECT" !== r[0].tagName && "OPTION" !== r[0].tagName && "checkbox" !== r[0].type && "radio" !== r[0].type || (n = "click");
        var i = ".validate-laravelValidation";
        r.off(i).off(n + i + "-" + t.name).on(n + i + "-" + t.name, function () {
          $(t).valid();
        });
      }
    ...
    isTimezone: function isTimezone(e) {
      var t = {
        ...
        utc: [""]
          ...
          r = a[0].toLowerCase(),
          n = "";
      return a[1] && (n = a[1].toLowerCase()), r in t && (0 === t[r].length || t[r].indexOf(n) !== -1);
    }
  }
}), $.extend(!0, laravelValidation, {
  methods: {
    ...
    RequiredWith: function RequiredWith(e, t, a) {
      ...
      return $.each(a, function (e, a) {
        ...
        n = n || void 0 !== s && $.validator.methods.required.call(r, i.elementValue(s), s, !0);
    ...
    RequiredIf: function RequiredIf(e, t, a) {
      ...
      if (void 0 !== r) {
        ...
        if ("undefined" != typeof n) {
          var i = a.slice(1);
          if ($.inArray(n, i) !== -1) return $.validator.methods.required.call(this, e, t, !0);
        }
      }
    ...
    Same: function Same(e, t, a) {
      var r = laravelValidation.helpers.dependentElement(this, t, a[0]);
      return void 0 !== r && String(e) === String(this.elementValue(r));
    },
    InArray: function InArray(e, t, a) {
      if ("undefined" == typeof a[0]) return !1;

      for (var r = this.elements(), n = !1, i = laravelValidation.helpers.regexFromWildcard(a[0]), s = 0; s < r.length; s++) {
        var o = r[s].name;
    ...
    Array: function Array(e, t) {
      return t.name.indexOf("[") !== -1 && t.name.indexOf("]") !== -1 || $.isArray(e);
    },
    Boolean: function Boolean(e) {
    ...
    Dimensions: function Dimensions(value, element, params, callback) {
      if (!(window.File && window.FileReader && window.FileList && window.Blob)) return !0;
      if (null === element.files || "undefined" == typeof element.files[0]) return !1;
    ...
    Before: function Before(e, t, a) {
      ...
      if (isNaN(r)) {
        var n = laravelValidation.helpers.dependentElement(this, t, a);
        if (void 0 === n) return !1;
        r = laravelValidation.helpers.parseTime(this.elementValue(n), n);
      }
...
/***/ 7:
/*!*****************************************************************!*\
  !*** multi ./resources/admin/js/app_modules/form-validation.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\service-mario\resources\admin\js\app_modules\form-validation.js */"./resources/admin/js/app_modules/form-validation.js");
