...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="column">
            ...
            <p>{{ config('constants.site_title', 'Service Mario')  }} é a maneira mais inteligente de se locomover. Um toque e um carro ou moto vai até você. Seu @lang('admin.provider') sabe exatamente para onde ir. E você pode pagar com dinheiro ou cartão.</p>
...
<div class="row gray-section pad-60">
    <div class="container">                
        <div class="column">
            ...
            <div class="title-divider"></div>
            <p>Viagem para o trabalho, entregas, passeios pela cidade, ir para a faculdade, aquela balada noturna, aonde quer que você vá, conte com o {{ config('constants.site_title', 'Service Mario') }} para uma viagem segura.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">SAIBA MAIS <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="column img-box text-center"> 
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="column content-block">
            ...
            <div class="title-divider"></div>
            <p>Vai de carro ou de moto? com o {{ config('constants.site_title', 'Service Mario') }} você anda de tarnsporte executivo com baixo custo.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">SAIBA MAIS <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">                
        <div class="column content-block">
            ...
            <div class="title-divider"></div>
            <p>O {{ config('constants.site_title', 'Service Mario') }} conta com os mais responsáveis @lang('admin.provider')s, são pessoas com grande experiência e apaixonadas pelo que fazem. Eles são mães e pais, alunos e professores, veteranos vizinhos, amigos, nossos parceiros do dia-a-dia.</p>
...
<div class="row white-section pad-60 ">
    <div class="container">
        ...
        <div class="column content-block">
            ...
            <div class="title-divider"></div>
            <p>Uma cidade com o {{ config('constants.site_title', 'Service Mario') }} tem mais oportunidades econômicas para os residentes e melhor acesso ao transporte para aqueles que não o possuem.</p>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">
        <div class="column content-block">
            ...
            <div class="title-divider"></div>
            <p>Seja andando no banco de trás ou dirigindo na frente, todo o sistema do {{ config('constants.site_title', 'Service Mario') }} foi desenvovido para dar a melhor experiencia de viagem com total qualidade e segurança.</p>
...
<!--<div class="row find-city">
    <div class="container pad-60 content-block center">
        <h2>{{ config('constants.site_title','Service Mario') }} na sua cidade</h2>
        <div class="columns">
            <div class="column">
        <form>
