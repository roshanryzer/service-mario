                        ...
                        <div class="column">
                            <form action="{{ route('admin.settings.store') }}" method="POST"
                                ...
                                <div class="field">
                                    ...
                                    <div class="">
                                        <input class="input" type="text"
                                            value="{{ config('constants.site_title', 'Service Mario')  }}" name="site_title"
                                ...
                                <div class="field">
                                    ...
                                    <div class="">
                                        <input class="input" type="text"
                                            value="{{ config('constants.site_copyright', '&copy; '.date('Y').' Service Mario') }}"
                            ...
                            <form action="{{ route('admin.settings.store') }}" method="POST"
                                ...
                                <div class="field">
                                    <label for="base_price" class="column label">@lang('admin.payment.currency')
                                        ( <strong>{{ config('constants.currency', 'रु')  }} </strong>)
                                    </label>
                                    <div class="select">
...
<!--                                            <option @if(config('constants.currency')=="RM" ) selected @endif value="RM">
                                            ...
                                            <option @if(config('constants.currency')=="रु" ) selected @endif value="रु">
