        ...
        <div class="menu-wrapper py-1">
            <aside class="menu ">
                ...
                <ul class="menu-list">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="{{ route('admin.dispute.index') }}">
                                                    @lang('admin.include.dispute_type')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.userdisputes') }}">
                                                    @lang('admin.include.dispute_request')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    @can('heat-map')
                        <li>
                            <a href="{{ route('admin.map.index') }}"
                               class="{{ Request::segment(2) === 'map' ? 'is-active has-background-primary' : null }} has-text-black">
                        ...
                        <li>
                            <a href="{{ route('admin.heatmap') }}"
                               class="{{ Request::segment(2) === 'heatmap' ? 'is-active has-background-primary' : null }} has-text-black">
                                <i class="ti-map"></i>
                                            ...
                                            @can('service-types-list')
                                                <li>
                                                    <a href="{{ route('admin.service.index') }}">
                                                        @lang('admin.include.list_service_types')</a>
                                                </li>
                                            @endcan
                                            @can('peak-hour-list')
                                                <li>
                                                    <a href="{{ route('admin.peakhour.index') }}">
                                                        @lang('admin.include.peakhour')</a>
                                                </li>
                                                @endcan
                                        </ul>
                                    </div>
                    ...
                    @can('documents-list')
                        <li>
                            <a class="has-text-black {{ Request::segment(2) === 'document' ? 'is-active has-background-primary' : null }}"
                    ...
                    @can('notification-list')
                        <li>
                            <a class="has-text-black {{ Request::segment(2) === 'notification' ? 'is-active has-background-primary' : null }}"
                    ...
                    @can('cancel-reasons-list')
                        <li>
                            <a class="has-text-black {{ Request::segment(2) === 'reason' ? 'is-active has-background-primary' : null }}"
                    ...
                    @endcan
                    <li>
                        <a class="has-text-black {{ Request::segment(2) === 'banner' ? 'is-active has-background-primary' : null }}"
                                        ...
                                        @can('role-list')
                                            <li>
                                                <a href="{{ route('admin.role.index') }}">
                                                    @lang('admin.include.role_types')</a>
                                            </li>
                                        @endcan
                                        @can('sub-admin-list')
                                            <li>
                                                <a href="{{ route('admin.sub-admins.index') }}">
                                                    @lang('admin.include.sub_admins')</a>
                                            </li>
                                            @endcan
                                    </div>
                                </div>
                    ...
                    @can('user-list')
                        <li>
                            <a href="{{ route('admin.user.index') }}"
                               class="has-text-black {{ Request::segment(2) === 'user' ? ' is-active has-background-primary' : null }}">
                                <i class="fa fa-user" aria-hidden="true"></i>
                    ...
                    @can('provider-list')
                        <li>
                            <a href="{{ route('admin.provider.index') }}"
                               class="has-text-black {{ Request::segment(2) === 'provider' ? ' is-active has-background-primary' : null }}">
                    ...
                    @can('dispatcher-list')
                        <li>
                            <a href="{{ route('admin.dispatch-manager.index') }}"
                               class="has-text-black {{ Request::segment(2) === 'dispatch-manager' ? ' is-active has-background-primary' : null }}">
                    ...
                    @can('account-manager-list')
                        <li>
                            <a href="{{ route('admin.account-manager.index') }}"
                               class="has-text-black {{ Request::segment(2) === 'account-manager' ? ' is-active has-background-primary' : null }}">
                    ...
                    @can('dispute-manager-list')
                        <li>
                            <a href="{{ route('admin.dispute-manager.index') }}"
                               class="has-text-black {{ Request::segment(2) === 'dispute-manager' ? ' is-active has-background-primary' : null }}">
                                <img src="{{asset('asset/img/account.png')}}" style="filter: invert(100%);">
                    ...
                    @role('ADMIN')
                    <li class="menu-title">
                        @lang('admin.include.accounts')</li>
                    @endrole
                    @can('statements')
                                        ...
                                        <ul>
                                            <li>
                                                <a href="{{ route('admin.ride.statement') }}">
                                                    @lang('admin.include.overall_ride_statments')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.ride.statement.provider') }}">
                                                    @lang('admin.include.provider_statement')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.ride.statement.user') }}">
                                                    @lang('admin.include.user_statement')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.ride.statement.today') }}">
                                                    @lang('admin.include.daily_statement')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.ride.statement.monthly') }}">
                                                    @lang('admin.include.monthly_statement')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.ride.statement.yearly') }}">
                                                    @lang('admin.include.yearly_statement')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                                <div class="dropdown-content">
                                    <div class="dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="{{ route('admin.providertransfer') }}">
                                                    @lang('admin.include.provider_request')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.transactions') }}">
                                                    @lang('admin.include.all_transaction')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="{{ route('admin.user.review') }}">
                                                    @lang('admin.include.user_ratings')</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin.provider.review') }}">
                                                    @lang('admin.include.provider_ratings')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    @can('promocodes-list')
                        ...
                        <li>
                            <a href="{{ route('admin.promocode.index') }}"
                               class="has-text-black {{ Request::segment(2) === 'promocode' ? ' is-active has-background-primary' : null }}">
                    ...
                    @role('ADMIN')
                    <li class="menu-title">
                        @lang('admin.include.payment_details')</li>
                    @endrole
                    <li>
                        <a href="{{ route('admin.stripe.index') }}"
                           class="has-text-black {{ Request::segment(2) === 'stripe' ? ' is-active has-background-primary' : null }}">
                    ...
                    @can('payment-history')
                        <li>
                            <a href="{{ route('admin.payment') }}"
                               class="has-text-black {{ Request::segment(2) === 'payment' ? ' is-active has-background-primary' : null }}">
                                <i class="fa fa-money" aria-hidden="true"></i>
                    ...
                    @can('payment-settings')
                        <li>
                            <a href="{{ route('admin.settings.payment') }}"
                               class="has-text-black {{ Request::segment(2) === 'settings' ? ' is-active has-background-primary' : null }}">
                    ...
                    <li class="menu-title">
                        @lang('admin.include.settings')</li>
                    @can('site-settings')
                        <li>
                            <a href="{{ route('admin.settings') }}"
                               class="has-text-black {{ Request::segment(2) === 'site' ? ' is-active has-background-primary' : null }}">
                    ...
                    @role('ADMIN')
                    <li class="menu-title">
                        @lang('admin.include.others')</li>
                    @endrole

                    @can('cms-pages')
                        <li>
                            <a href="{{ route('admin.cmspages') }}"
                               class="has-text-black {{ Request::segment(2) === 'pages' ? ' is-active has-background-primary' : null }}">
                                <i class="ti-file"></i>
                    ...
                    @can('custom-push')
                        <li>
                            <a href="{{ route('admin.push') }}"
                               class="has-text-black {{ Request::segment(2) === 'send' ? ' is-active has-background-primary' : null }}">
                    ...
                    @role('ADMIN')
                    <li class="menu-title">
                        @lang('admin.include.account')</li>
                    @endrole

                    @can('account-settings')
                        <li>
                            <a href="{{ route('admin.profile') }}"
                               class="has-text-black {{ Request::segment(2) === 'profile' ? ' is-active has-background-primary' : null }}">
                    ...
                    @can('change-password')
                        <li>
                            <a href="{{ route('admin.password') }}"
                               class="has-text-black {{ Request::segment(2) === 'password' ? ' is-active has-background-primary' : null }}">
