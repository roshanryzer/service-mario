{{--@extends('admin.base.layouts.master')--}}
...
@section('content')
    ...
    <div class="max-width-1200">
        <div class="flexbox-annotated-section">
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('setting.email.title') }}</h2>
                </div>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20 email-template-edit-wrap">
                    ...
                    <div class="form-group">
                        ...
                        <label class="text-title-field"
                               for="email_content">{{ trans('setting.email.content') }}</label>
        ...
        <div class="flexbox-annotated-section" style="border: none">
            ...
            <div class="flexbox-annotated-section-content">
                <a href="{{ route('settings.email') }}" class="btn btn-secondary">{{ trans('setting.email.back') }}</a>
                <a class="btn btn-warning btn-trigger-reset-to-default" data-target="{{ route('setting.email.template.reset-to-default') }}">{{ trans('setting.email.reset_to_default') }}</a>
                <button class="btn btn-info" type="submit" name="submit">{{ trans('setting.save_settings') }}</button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}

    {!! Form::modalAction('reset-template-to-default-modal', trans('setting.email.confirm_reset'), 'info', trans('setting.email.confirm_message'), 'reset-template-to-default-button', trans('setting.email.continue')) !!}
@endsection
