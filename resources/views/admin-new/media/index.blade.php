...
{{--    <link rel="stylesheet" type="text/css" href="{{ asset(mix('admin/vendors/css/extensions/jquery.contextMenu.min.css')) }}">--}}
    <link rel="stylesheet" type="text/css" href="{{asset('admin/vendors/css/tables/datatable/datatables.min.css')}}">
@endsection
{{-- page styles --}}
@section('page-style')
    <!-- -->
    <link rel="stylesheet" href="{{ asset(('admin/css/media/file-manager.css')) }}">
    <link rel="stylesheet" href="{{ asset(('admin/css/media/data-list-view.css')) }}">
    <link rel="stylesheet" href="{{ asset(mix('admin/css/media/media.css')) }}">
{{--    {!! RsMedia::renderHeader() !!}--}}
@endsection
@include('admin.media.media-sidebar')
                            ...
                            <div class="card-content py-50 px-1 folder-info">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                                        ...
                                        <li data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="George Nordic" class="avatar pull-up">
                                            <img class="media-object rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-5.jpg')}}" alt="Avatar" height="30"
                                                 width="30">
                                        </li>
                                    </ul>
                                </div>
...
@section('vendor-script')
    ...
    <script src="{{asset('admin/js/scripts/extensions/copy-to-clipboard.js')}}"></script>
    <script src="{{ asset(mix('admin/vendors/js/extensions/jquery.contextMenu.min.js')) }}"></script>
    <script src="{{ asset(mix('admin/vendors/js/extensions/jquery.ui.position.min.js')) }}"></script>
@endsection
@section('page-script')
    <script src="{{asset('admin/js/media/file-manager.js')}}"></script>
