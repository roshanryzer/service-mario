    ...
    <div class="modal-dialog modal-full">
        <div class="modal-content bb-loading">
            <div class="modal-header">
                <h4 class="modal-title"><i class="til_img"></i><strong>{{ trans('media.gallery') }}</strong></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="{{ trans('media.close') }}"><span aria-hidden="true">&times;</span></button>
            </div>
