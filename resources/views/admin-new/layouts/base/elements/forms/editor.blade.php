<div style="height: 34px;">
    ...
    <span class="editor-action-item action-show-hide-editor">
        <button class="btn btn-primary show-hide-editor-btn" type="button" data-result="{{ $result }}">{{ trans('forms.show_hide_editor') }}</button>
    </span>
    ...
    @if (isset($attributes['with-short-code']) && $attributes['with-short-code'] == true)
        <span class="editor-action-item list-shortcode-items">
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle add_shortcode_btn_trigger" data-result="{{ $result }}" type="button" data-toggle="dropdown"><i class="fa fa-code"></i> {{ trans('forms.short_code') }}
                </button>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h4 class="modal-title"><i class="til_img"></i><strong>{{ trans('forms.add_short_code') }}</strong></h4>
                        ...
                        <div class="modal-footer">
                            <button class="float-left btn btn-secondary" data-dismiss="modal">{{ trans('tables.cancel') }}</button>
                            <a class="float-right btn btn-primary add_short_code_btn" href="#">{{ trans('forms.add') }}</a>
                        </div>
                    </div>
                </div>
            </div>
