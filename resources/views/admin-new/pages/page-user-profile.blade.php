...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/users.css')) }}">
@endsection
@section('content')
<div id="user-profile">
  <div class="row">
        ...
        <div class="profile-header mb-2">
          <div class="relative">
            <div class="cover-container">
              <img class="img-fluid bg-cover rounded-0 w-100" src="{{ asset('admin/images/profile/user-uploads/cover.jpg') }}" alt="User Profile Image">
            </div>
            <div class="profile-img-container d-flex align-items-center justify-content-between">
              <img src="{{ asset('admin/images/profile/user-uploads/user-13.jpg') }}" class="rounded-circle img-border box-shadow-1" alt="Card image">
          ...
          <div class="card-body suggested-block">
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-09.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-08.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>The Devil's</p>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-1">
                <img src="{{ asset('admin/images/profile/pages/page-03.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>The Magician</p>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-02.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>AC/DC</p>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-07.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>Eat Hard</p>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-04.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>B4B</p>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-05.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>Kylie Jenner</p>
                <span class="font-small-2">Public Figure</span>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-01.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>RDJ</p>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/profile/pages/page-06.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
                <p>Taylor Swift</p>
                <span class="font-small-2">Music</span>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="twitter-feed">
              <div class="d-flex justify-content-start align-items-center mb-1">
                <div class="avatar mr-50">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-12.jpg') }}" alt="avtar img holder" height="35" width="35">
                </div>
                <div class="user-page-info">
      ...
      <div class="col-lg-6 col-12">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-1">
                <img src="{{ asset('admin/images/profile/user-uploads/user-01.jpg') }}" alt="avtar img holder" height="45" width="45">
              </div>
              <div class="user-page-info">
            ...
            <img class="img-fluid card-img-top rounded-sm mb-2" src="{{ asset('admin/images/profile/post-media/2.jpg') }}" alt="avtar img holder">
            <div class="d-flex justify-content-start align-items-center mb-1">
              ...
              <div class="ml-2">
                <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                  ...
                  data-original-title="Vinnie Mostowy" class="avatar pull-up">
                    <img class="media-object rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-4.jpg') }}" alt="Avatar" height="30" width="30">
                  </li>
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-6.jpg') }}" alt="Avatar" height="30" width="30">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-2">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-8.jpg') }}" alt="Avatar" height="30" width="30">
              </div>
              <div class="user-page-info">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <img class="img-fluid rounded-sm mb-2" src="{{ asset('admin/images/profile/post-media/25.jpg') }}" alt="avtar img holder">
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="d-flex align-items-center">
                <i class="feather icon-heart font-medium-2 mr-50"></i>
                <span>276</span>
      ...
      <div class="col-lg-3 col-12">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-01.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-02.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-03.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-04.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-05.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-06.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-07.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-08.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
              <div class="col-md-4 col-6 user-latest-img">
                <img src="{{ asset('admin/images/profile/user-uploads/user-09.jpg') }}" class="img-fluid mb-1 rounded-sm" alt="avtar img holder">
              </div>
            </div>
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-5.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-6.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-7.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-8.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-9.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-10.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="d-flex justify-content-start align-items-center mb-1">
              <div class="avatar mr-50">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-11.jpg') }}" alt="avtar img holder" height="35" width="35">
              </div>
              <div class="user-page-info">
            ...
            <div class="polls-info mt-1">
              ...
              <ul class="list-unstyled users-list d-flex">
                ...
                data-original-title="Tonia Seabold" class="avatar pull-up ml-0">
                  <img class="media-object rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-12.jpg') }}" alt="Avatar" height="30" width="30">
                </li>
                <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
...
@section('page-script')
{{-- Page js files --}}
        <script src="{{ asset(mix('admin/js/scripts/pages/user-profile.js')) }}"></script>
@endsection
