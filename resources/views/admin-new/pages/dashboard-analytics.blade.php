...
@section('vendor-style')
        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/tether-theme-arrows.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/tether.min.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/shepherd-theme-default.css')) }}">
@endsection
@section('page-style')
        <!-- Page css files -->
        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/tour/tour.css')) }}">
  @endsection
          ...
          <div class="card bg-analytics text-white">
            <div class="card-content">
              <div class="card-body text-center">
                <img src="{{ asset('admin/images/elements/decore-left.png') }}" class="img-left" alt="card-img-left">
                <img src="{{ asset('admin/images/elements/decore-right.png')}}" class="img-right" alt="card-img-right">
...
@section('vendor-script')
        ...
        <script src="{{ asset(mix('admin/vendors/js/extensions/tether.min.js')) }}"></script>
        <script src="{{ asset(mix('admin/vendors/js/extensions/shepherd.min.js')) }}"></script>
@endsection
@section('page-script')
        <!-- Page js files -->
