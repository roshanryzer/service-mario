...
<!-- vendor js files -->
        <script src="{{ asset(mix('admin/vendors/js/pagination/jquery.bootpag.min.js')) }}"></script>
        <script src="{{ asset(mix('admin/vendors/js/pagination/jquery.twbsPagination.min.js')) }}"></script>
@endsection
@section('page-script')
        {{-- Page js files --}}
        <script src="{{ asset(mix('admin/js/scripts/pagination/pagination.js')) }}"></script>
@endsection
