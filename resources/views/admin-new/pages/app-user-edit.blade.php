...
@section('page-style')
        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-user.css')) }}">
          ...
          <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <div class="media mb-2">
              <a class="mr-2 my-25" href="#">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-12.jpg') }}" alt="users avatar"
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ asset(mix('admin/js/scripts/pages/app-user.js')) }}"></script>
  <script src="{{ asset(mix('admin/js/scripts/navs/navs.js')) }}"></script>
@endsection
