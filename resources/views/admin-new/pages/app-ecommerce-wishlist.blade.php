...
<section id="wishlist" class="grid-view wishlist-items">
        ...
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/1.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/2.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/3.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/4.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/5.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/6.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/7.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/8.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/9.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/10.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
    ...
    <div class="card ecommerce-card">
        <div class="card-content">
            <a href="app-ecommerce-details">
                <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/11.png') }}" class="img-fluid" alt="img-placeholder">
                </div>
                <div class="card-body">
                    <div class="item-wrapper">
                    <div class="item-rating">
