...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/error.css')) }}">
@endsection
@section('content')
<!-- error 500 -->
    ...
    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
      <div class="card-content">
        <div class="card-body text-center">
          <img src="{{ asset('admin/images/pages/500.png') }}" class="img-fluid align-self-center" alt="branding logo">
