...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/invoice.css')) }}">
@endsection
@section('content')
      ...
      <div id="invoice-company-details" class="row">
          <div class="col-md-6 col-sm-12 text-left pt-1">
              <div class="media pt-1">
                  <img src="{{ asset('admin/images/logo/logo.png') }}" alt="company logo" class=""/>
              </div>
          </div>
...
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/pages/invoice.js')) }}"></script>
@endsection
