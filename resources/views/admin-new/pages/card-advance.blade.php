    ...
    <div class="row match-height">
      <div class="col-xl-4 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-content">
            ...
            <div class="card-body">
              <h5>Vuexy Admin</h5>
              <p class="card-text  mb-0">By Service Mario Creative Studio</p>
      ...
      <div class="col-xl-4 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <img class="card-img img-fluid mb-1" src="{{ asset('admin/images/pages/content-img-2.jpg') }}"
                alt="Card image cap">
              <h5 class="mt-1">Vuexy Admin</h5>
              <p class="card-text">By Service Mario Creative Studio</p>
              <hr class="my-1">
      ...
      <div class="col-xl-4 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <img class="card-img img-fluid mb-1" src="{{ asset('admin/images/pages/content-img-3.jpg') }}"
                alt="Card image cap">
        ...
        <div class="card">
          <div class="card-header mx-auto">
            <div class="avatar avatar-xl">
              <img class="img-fluid" src="{{ asset('admin/images/portrait/small/avatar-s-12.jpg') }}"
                alt="img placeholder">
            </div>
          </div>
          <div class="card-content">
      ...
      <div class="col-xl-4 col-md-6 col-sm-12 profile-card-3">
        <div class="card">
          <div class="card-header mx-auto">
            <div class="avatar avatar-xl">
              <img class="img-fluid" src="{{ asset('admin/images/portrait/small/avatar-s-1.jpg') }}" alt="img placeholder">
            </div>
          </div>
          <div class="card-content">
            <div class="card-body text-center">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card overlay-img-card text-white">
          <img src="{{ asset('admin/images/pages/card-image-6.jpg') }}" class="card-img" alt="card-img-6">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card overlay-img-card text-white">
          <img src="{{ asset('admin/images/pages/card-image-5.jpg') }}" class="card-img" alt="card-img-6">
                ...
                <div class="chat chat-left">
                  <div class="chat-avatar mt-50">
                    <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title=""
                      data-original-title="">
                      <img src="{{ asset('admin/images/portrait/small/avatar-s-2.jpg') }}" alt="avatar" height="40"
                        width="40" />
                    </a>
                  </div>
                  <div class="chat-body">
                ...
                <div class="chat">
                  <div class="chat-avatar">
                    <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title=""
                      data-original-title="">
                      <img src="{{ asset('admin/images/portrait/small/avatar-s-5.jpg') }}" alt="avatar" height="40"
                        width="40" />
                    </a>
                  </div>
                  <div class="chat-body">
      ...
      <div class="col-lg-4 col-sm-12">
        <div class="card">
          <div class="card-header">
            ...
            <p class="">by Service Mario Creative Studio</p>
          ...
          <div class="card-content">
            <div class="card-body">
              <img class="img-fluid" src="{{ asset('admin/images/pages/content-img-4.jpg') }}" alt="img placeholder">
...
@section('page-script')
{{-- Page js files --}}
        <script src="{{ asset(mix('admin/js/scripts/pages/app-chat.js')) }}"></script>
@endsection
