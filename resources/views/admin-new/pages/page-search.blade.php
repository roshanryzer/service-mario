...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/search.css')) }}">
@endsection
@section('content')
<!-- Search Bar -->
                      ...
                      <ul class="media-list p-0">
                          ...
                          <li class="media d-sm-flex d-block">
                              <div class="media-left pr-sm-2 pr-0">
                                  <a href="#">
                                      <img class="media-object" src="{{ asset('admin/images/pages/search-result.jpg') }}" alt="Generic placeholder image">
                                  </a>
                              </div>
          ...
          <div class="card bg-transparent border-light shadow-none">
              <div class="card-body">
                  <div class="text-center">
                      <img class="img-fluid rounded" src="{{ asset('admin/images/pages/modern.jpg') }}" alt="logo">
                  </div>
                  ...
                  <div class="knowledge-panel-suggestion">
                      <div class="suggestion-1 d-inline-block text-center mr-2">
                          <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875" target="_blank">
                              <img src="{{ asset('admin/images/pages/1-apex.png') }}" alt="Image description" height="40" width="40">
                      ...
                      <div class="suggestion-1 d-inline-block text-center mr-2">
                          <a href="https://themeforest.net/item/convex-angular-bootstrap-admin-dashboard-template/22424619" target="_blank">
                              <img src="{{ asset('admin/images/pages/3-convex.png') }}" alt="Image description" height="40" width="40">
                      ...
                      <div class="suggestion-1 d-inline-block text-center mr-2">
                          <a href="https://themeforest.net/item/materialize-material-design-admin-template/11446068" target="_blank">
                              <img src="{{ asset('admin/images/pages/4-materialize.png') }}" alt="Image description" height="40" width="40">
                      ...
                      <div class="suggestion-1 d-inline-block text-center">
                          <a href="https://themeforest.net/item/stack-responsive-bootstrap-4-admin-template/20039431" target="_blank">
                              <img src="{{ asset('admin/images/pages/2-stack.png') }}" alt="Image description" height="40" width="40">
