...
@section('page-style')
  {{-- Page Css files --}}
  <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-ecommerce-details.css')) }}">
      ...
      <div class="row mb-5 mt-2">
        <div class="col-12 col-md-5 d-flex align-items-center justify-content-center mb-2 mb-md-0">
          <div class="d-flex align-items-center justify-content-center">
            <img src="{{ asset('admin/images/elements/macbook-pro.png') }}" class="img-fluid" alt="product image">
          </div>
        </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide rounded swiper-shadow">
            ...
            <div class="img-container w-50 mx-auto my-2 py-75">
              <img src="{{ asset('admin/images/elements/apple-watch.png') }}" class="img-fluid" alt="image">
            </div>
            <div class="item-meta">
          ...
          <div class="swiper-slide rounded swiper-shadow">
            ...
            <div class="img-container w-50 mx-auto my-2 py-75">
              <img src="{{ asset('admin/images/elements/beats-headphones.png') }}" class="img-fluid" alt="image">
            </div>
            <div class="item-meta">
              <div class="product-rating">
                <i class="feather icon-star text-warning"></i>
          ...
          <div class="swiper-slide rounded swiper-shadow">
            ...
            <div class="img-container w-50 mx-auto my-3 py-50">
              <img src="{{ asset('admin/images/elements/macbook-pro.png') }}" class="img-fluid" alt="image">
            </div>
            <div class="item-meta">
              <div class="product-rating">
                <i class="feather icon-star text-warning"></i>
          ...
          <div class="swiper-slide rounded swiper-shadow">
            ...
            <div class="img-container w-50 mx-auto my-2 py-75">
              <img src="{{ asset('admin/images/elements/homepod.png') }}" class="img-fluid" alt="image">
            </div>
            <div class="item-meta">
              <div class="product-rating">
                <i class="feather icon-star text-warning"></i>
          ...
          <div class="swiper-slide rounded swiper-shadow">
            ...
            <div class="img-container w-50 mx-auto my-2 py-75">
              <img src="{{ asset('admin/images/elements/magic-mouse.png') }}" class="img-fluid" alt="image">
            </div>
            <div class="item-meta">
              <div class="product-rating">
                <i class="feather icon-star text-warning"></i>
          ...
          <div class="swiper-slide rounded swiper-shadow">
            ...
            <div class="img-container w-50 mx-auto my-2 py-75">
              <img src="{{ asset('admin/images/elements/iphone-x.png') }}" class="img-fluid" alt="image">
            </div>
            <div class="item-meta">
              <div class="product-rating">
                <i class="feather icon-star text-warning"></i>
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ asset(mix('admin/js/scripts/pages/app-ecommerce-details.js')) }}"></script>
  <script src="{{ asset(mix('admin/js/scripts/forms/number-input.js')) }}"></script>
@endsection
