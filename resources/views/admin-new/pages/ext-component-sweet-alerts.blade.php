...
@section('vendor-style')
        <!-- vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/animate/animate.css')) }}">
...
@section('vendor-script')
        ...
        <script src="{{ asset(mix('admin/vendors/js/extensions/polyfill.min.js')) }}"></script>
@endsection
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/extensions/sweet-alerts.js')) }}"></script>
@endsection
