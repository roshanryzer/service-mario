...
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-todo.css')) }}">
@endsection
@include('admin/pages/app-todo-sidebar')
@section('content')
...
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/pages/app-todo.js')) }}"></script>
@endsection
