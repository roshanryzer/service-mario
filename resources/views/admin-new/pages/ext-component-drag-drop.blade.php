...
@section('vendor-style')
        <!-- vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/dragula.min.css')) }}">
@endsection
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/extensions/drag-and-drop.css')) }}">
@endsection
@section('content')
          ...
          <div class="card-body">
            ...
            <ul class="list-group" id="basic-list-group">
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-12.jpg') }}" class="rounded-circle mr-2"
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-1.jpg') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-2.jpg') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-3.jpg') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
              ...
              <li class="list-group-item">
                <div class="media">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-4.jpg') }}" class="rounded-circle mr-2"
                    alt="img-placeholder" height="50" width="50">
                  <div class="media-body">
...
@section('vendor-script')
        <!-- vendor files -->
        <script src="{{ asset(mix('admin/vendors/js/extensions/dragula.min.js')) }}"></script>
@endsection
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/extensions/drag-drop.js')) }}"></script>
@endsection
