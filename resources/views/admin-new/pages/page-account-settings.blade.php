...
@section('page-style')
        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/css/core/colors/palette-noui.css')) }}">
@endsection
                ...
                <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                  ...
                  <div class="media">
                    <a href="javascript: void(0);">
                      <img src="{{ asset('admin/images/portrait/small/avatar-s-12.jpg') }}" class="rounded mr-75"
...
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/pages/account-setting.js')) }}"></script>
@endsection
