...
@section('vendor-style')
        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/editors/quill/quill.bubble.css')) }}">
@endsection
@section('content')
<!-- Snow Editor start -->
...
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/editors/editor-quill.js')) }}"></script>
@endsection
