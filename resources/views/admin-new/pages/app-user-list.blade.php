...
@section('vendor-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/tables/ag-grid/ag-grid.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/tables/ag-grid/ag-theme-material.css')) }}">
@endsection

@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-user.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/aggrid.css')) }}">
@endsection
...
@section('vendor-script')
  {{-- Vendor js files --}}
  <script src="{{ asset(mix('admin/vendors/js/tables/ag-grid/ag-grid-community.min.noStyle.js')) }}"></script>
@endsection
