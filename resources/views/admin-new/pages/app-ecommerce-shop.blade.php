...
@extends((( $configData["mainLayoutType"] === 'horizontal') ? 'admin/layouts/horizontalDetachedLayoutMaster' : 'admin/layouts/detachedLayoutMaster' ))

@section('title', 'Shop')

@section('vendor-style')
        <!-- Vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/nouislider.min.css')) }}">
...
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/extensions/noui-slider.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-ecommerce-shop.css')) }}">
@endsection
@include('admin/pages/app-ecommerce-sidebar')
@section('content')
...
<section id="ecommerce-products" class="grid-view">
    ...
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/1.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/2.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/3.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/4.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/5.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/6.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/7.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/10.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
  ...
  <div class="card ecommerce-card">
    <div class="card-content">
      <a href="app-ecommerce-details">
        <div class="item-img text-center">
          <img class="img-fluid" src="{{ asset('admin/images/pages/eCommerce/9.png') }}" alt="img-placeholder">
        </div>
        <div class="card-body">
          <div class="item-wrapper">
            <div class="item-rating">
...
@section('vendor-script')
        ...
        <script src="{{ asset(mix('admin/vendors/js/extensions/wNumb.js')) }}"></script>
        <script src="{{ asset(mix('admin/vendors/js/extensions/nouislider.min.js')) }}"></script>
        <script src="{{ asset(mix('admin/vendors/js/forms/select/select2.full.min.js')) }}"></script>
@endsection
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/pages/app-ecommerce-shop.js')) }}"></script>
@endsection
