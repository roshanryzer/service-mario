...
@section('vendor-style')
        <!-- Vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/calendars/fullcalendar.min.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/calendars/extensions/daygrid.min.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/calendars/extensions/timegrid.min.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/pickers/pickadate/pickadate.css')) }}">
@endsection
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/calendars/fullcalendar.css')) }}">
@endsection
@section('content')
<!-- Full calendar start -->
...
@section('vendor-script')
  <!-- Vendor js files -->
  <script src="{{ asset(mix('admin/vendors/js/extensions/moment.min.js')) }}"></script>
  <script src="{{ asset(mix('admin/vendors/js/calendar/fullcalendar.min.js')) }}"></script>
  <script src="{{ asset(mix('admin/vendors/js/calendar/extensions/daygrid.min.js')) }}"></script>
  <script src="{{ asset(mix('admin/vendors/js/calendar/extensions/timegrid.min.js')) }}"></script>
  <script src="{{ asset(mix('admin/vendors/js/calendar/extensions/interactions.min.js')) }}"></script>
  <script src="{{ asset(mix('admin/vendors/js/pickers/pickadate/picker.js')) }}"></script>
  <script src="{{ asset(mix('admin/vendors/js/pickers/pickadate/picker.date.js')) }}"></script>
@endsection
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/extensions/fullcalendar.js')) }}"></script>
@endsection
