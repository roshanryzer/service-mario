      ...
      <div class="col-xl-4 col-md-6">
        <div class="card">
          ...
          <div class="card-content">
            <img class="img-fluid" src="{{ asset('admin/images/slider/04.jpg') }}" alt="Card image cap">
            <div class="card-body">
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img src="{{ asset('admin/images/slider/01.jpg') }}" class="d-block w-100" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('admin/images/slider/02.jpg') }}" class="d-block w-100" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img src="{{ asset('admin/images/slider/03.jpg') }}" class="d-block w-100" alt="Third slide">
                </div>
              </div>
  ...
  <section id="card-caps">
    <div class="row my-3">
      <div class="col-xl-6 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-content">
            <img class="card-img-top img-fluid" src="{{ asset('admin/images/slider/05.jpg') }}" alt="Card image cap" />
            <div class="card-body">
      ...
      <div class="col-xl-6 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-content">
            ...
            <img class="card-img-bottom img-fluid" src="{{ asset('admin/images/slider/06.jpg') }}" alt="Card image cap">
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card">
          <div class="card-content">
            <img class="card-img img-fluid" src="{{ asset('admin/images/slider/04.jpg') }}" alt="Card image">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card text-white bg-gradient-primary text-center">
          <div class="card-content d-flex">
            <div class="card-body">
              <img src="{{ asset('admin/images/elements/apple-watch.png') }}" alt="element 01" width="150"
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-info text-center bg-transparent">
          <div class="card-content">
            <img src="{{ asset('admin/images/elements/macbook-pro.png') }}" alt="element 04" width="200"
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card text-white bg-gradient-danger text-center">
          <div class="card-content d-flex">
            <div class="card-body">
              <img src="{{ asset('admin/images/elements/iphone-x.png') }}" alt="element 03" width="150" height="150"
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-warning text-center bg-transparent">
          <div class="card-content">
            <div class="card-body">
              <img src="{{ asset('admin/images/elements/magic-mouse.png') }}" alt="element 05" width="150" class="mb-1">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card text-white bg-gradient-success text-center">
          <div class="card-content">
            <div class="card-body">
              <img src="{{ asset('admin/images/elements/beats-headphones.png') }}" alt="element 02" width="150"
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-danger text-center bg-transparent">
          <div class="card-content d-flex">
            <div class="card-body">
              <img src="{{ asset('admin/images/elements/ipad-pro.png') }}" alt="element 06" height="100" class="mb-1">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card-group">
          ...
          <div class="card">
            <div class="card-content">
              <img class="card-img-top img-fluid" src="{{ asset('admin/images/pages/content-img-3.jpg') }}"
                alt="Card image cap" />
              <div class="card-body">
          ...
          <div class="card">
            <div class="card-content">
              <img class="card-img-top img-fluid" src="{{ asset('admin/images/pages/content-img-2.jpg') }}"
                alt="Card image cap" />
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">This card has supporting text below as a natural lead-in to additional
          ...
          <div class="card">
            <div class="card-content">
              <img class="card-img-top img-fluid" src="{{ asset('admin/images/pages/content-img-4.jpg') }}"
                alt="Card image cap" />
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">This card has supporting text below as a natural lead-in to additional
          ...
          <div class="card">
            <div class="card-content">
              <img class="card-img-top img-fluid" src="{{ asset('admin/images/pages/content-img-1.jpg') }}"
                alt="Card image cap" />
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">This card has supporting text below as a natural lead-in to additional
      ...
      <div class="col-12">
        <div class="card-deck-wrapper">
          <div class="card-deck">
            <div class="card">
              <div class="card-content">
                <img class="card-img-top img-fluid" src="{{ asset('admin/images/slider/01.jpg') }}" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
            ...
            <div class="card">
              <div class="card-content">
                <img class="card-img-top img-fluid" src="{{ asset('admin/images/slider/04.jpg') }}" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">This card has supporting text below as a natural lead-in to
                    additional content.</p>
            ...
            <div class="card">
              <div class="card-content">
                <img class="card-img-top img-fluid" src="{{ asset('admin/images/slider/06.jpg') }}" alt="Card image cap" />
                <div class="card-body">
                  <h4 class="card-title">Card title</h4>
                  <p class="card-text">This card has supporting text below as a natural lead-in to
                    additional content.</p>
      ...
      <div class="col-md-12 mt-1">
        <div class="card-columns">
          ...
          <div class="card text-white bg-primary text-center">
            <div class="card-content">
              <div class="card-body">
                <img src="{{ asset('admin/images/elements/iphone-x.png') }}" alt="element 05" width="150"
          ...
          <div class="card text-white bg-gradient-info text-center">
            <div class="card-content">
              <div class="card-body">
                <img src="{{ asset('admin/images/elements/ipad-pro.png') }}" alt="element 02" width="120"
                  class="mb-1 img-fluid">
                <h3 class="card-title text-white">Ceramic Bottle</h3>
                <p class="card-text">456 items</p>
              </div>
          ...
          <div class="card">
            <div class="card-content">
              ...
              <img class="card-img-bottom img-fluid" src="{{ asset('admin/images/slider/01.jpg') }}" alt="Card image cap">
            </div>
          </div>
          <div class="card text-white">
            <div class="card-content">
              <img class="card-img img-fluid" src="{{ asset('admin/images/slider/03.jpg') }}" alt="Card image">
          ...
          <div class="card border-info text-center bg-transparent">
            <div class="card-content">
              <img src="{{ asset('admin/images/elements/macbook-pro.png') }}" alt="element 04" width="150"
