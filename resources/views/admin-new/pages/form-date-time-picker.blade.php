...
@section('vendor-script')
        ...
        <script src="{{ asset(mix('admin/vendors/js/pickers/pickadate/picker.time.js')) }}"></script>
        <script src="{{ asset(mix('admin/vendors/js/pickers/pickadate/legacy.js')) }}"></script>
@endsection
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/pickers/dateTime/pick-a-datetime.js')) }}"></script>
@endsection
