...
@section('vendor-style')
        <!-- vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/plyr.css')) }}">
@endsection
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/extensions/media-plyr.css')) }}">
@endsection
@section('content')
...
@section('vendor-script')
        <!-- vendor files -->
        <script src="{{ asset(mix('admin/vendors/js/media/plyr.js')) }}"></script>
        <script src="{{ asset(mix('admin/vendors/js/media/plyr.polyfilled.js')) }}"></script>

@endsection
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/extensions/media-plyr.js')) }}"></script>
@endsection
