...
@section('vendor-style')
        <!-- vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/jquery.contextMenu.min.css')) }}">
...
@section('page-style')
        ...
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/extensions/context-menu.css')) }}">
@endsection
@section('content')
  <!-- context-menu Starts -->
...
@section('page-script')
        <!-- Page js files -->
        <script src="{{ asset(mix('admin/js/scripts/extensions/context-menu.js')) }}"></script>
@endsection
