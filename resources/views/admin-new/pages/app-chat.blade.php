...
@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-chat.css')) }}">
@endsection
@include('admin/pages/app-chat-sidebar')
@section('content')
      ...
      <header class="chat_header d-flex justify-content-between align-items-center p-1">
        <div class="vs-con-items d-flex align-items-center">
          ...
          <div class="avatar user-profile-toggle m-0 m-0 mr-1">
            <img src="{{ asset('admin/images/portrait/small/avatar-s-1.jpg') }}" alt="" height="40" width="40" />
          ...
          <div class="chat">
            <div class="chat-avatar">
              <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                  <img src="{{ asset('admin/images/portrait/small/avatar-s-1.jpg') }}" alt="avatar" height="40" width="40"/>
              </a>
            </div>
            <div class="chat-body">
          ...
          <div class="chat chat-left">
            <div class="chat-avatar">
              <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                <img src="{{ asset('admin/images/portrait/small/avatar-s-7.jpg') }}" alt="avatar" height="40" width="40"/>
              </a>
            </div>
            <div class="chat-body">
              <div class="chat-content">
...
<div class="user-profile-sidebar">
  <header class="user-profile-header">
    ...
    <div class="header-profile-sidebar">
      <div class="avatar">
        <img src="{{ asset('admin/images/portrait/small/avatar-s-1.jpg') }}" alt="user_avatar" height="70" width="70">
