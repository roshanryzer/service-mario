...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/faq.css')) }}">
@endsection
@section('content')
              ...
              <div class="card-body">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-1.jpg') }}" alt="Avatar">
                      </div>
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-2.jpg') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-3.jpg') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-4.jpg') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
                  ...
                  <div class="supporter-details mt-2">
                      <div class="supporter-img d-inline-block">
                          <img class="rounded-circle" src="{{ asset('admin/images/portrait/small/avatar-s-5.jpg') }}" alt="Avatar">
                      </div>
                      <div class="supporter-info d-inline-block">
