...
@section('vendor-style')
        <!-- Vendor css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/forms/spinner/jquery.bootstrap-touchspin.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/vendors/css/extensions/toastr.css')) }}">
@endsection

@section('page-style')
        <!-- Page css files -->
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/app-ecommerce-shop.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/forms/wizard.css')) }}">
        <link rel="stylesheet" href="{{ asset(mix('admin/css/plugins/extensions/toastr.css')) }}">
@endsection
@section('content')
    ...
    <fieldset class="checkout-step-1 px-0">
        ...
        <div class="checkout-items">
            ...
            <div class="card-content">
                <a href="app-ecommerce-details">
                    <div class="item-img text-center">
                        <img src="{{ asset('admin/images/pages/eCommerce/9.png') }}" alt="img-placeholder">
                    </div>
                    <div class="card-body">
                    <div class="item-name">
            ...
            <div class="card-content">
                <a href="app-ecommerce-details">
                    <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/2.png') }}" alt="img-placeholder">
                    </div>
                    <div class="card-body">
                    <div class="item-name">
            ...
            <div class="card-content">
                <a href="app-ecommerce-details">
                    <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/3.png') }}" alt="img-placeholder">
                    </div>
                    <div class="card-body">
                    <div class="item-name">
            ...
            <div class="card-content">
                <a href="app-ecommerce-details">
                    <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/4.png') }}" alt="img-placeholder">
                    </div>
                    <div class="card-body">
                    <div class="item-name">
            ...
            <div class="card-content">
                <a href="app-ecommerce-details">
                    <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/10.png') }}" alt="img-placeholder">
                    </div>
                    <div class="card-body">
                    <div class="item-name">
            ...
            <div class="card-content">
                <a href="app-ecommerce-details">
                    <div class="item-img text-center">
                    <img src="{{ asset('admin/images/pages/eCommerce/6.png') }}" alt="img-placeholder">
                    </div>
                    <div class="card-body">
                    <div class="item-name">
        ...
        <div class="payment-type">
            ...
            <div class="card-content">
                ...
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <img src="{{ asset('admin/images/pages/eCommerce/bank.png') }}" alt="img-placeholder" height="40">
...
@section('vendor-script')
        ...
        <script src="{{ asset(mix('admin/vendors/js/extensions/jquery.steps.min.js')) }}"></script>
