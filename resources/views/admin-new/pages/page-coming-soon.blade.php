...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/coming-soon.css')) }}">
@endsection
@section('content')
        ...
        <div class="card text-center w-100 mb-0">
            ...
            <div class="card-content">
                <div class="card-body pt-0">
                    <img src="{{ asset('admin/images/pages/rocket.png') }}" class="img-responsive block width-150 mx-auto" width="150" alt="bg-img">
...
@section('vendor-script')
        {{-- vendor js files --}}
        <script src="{{ asset(mix('admin/vendors/js/coming-soon/jquery.countdown.min.js')) }}"></script>
@endsection

@section('page-script')
        {{-- Page js files --}}
        <script src="{{ asset(mix('admin/js/scripts/pages/coming-soon.js')) }}"></script>
@endsection
