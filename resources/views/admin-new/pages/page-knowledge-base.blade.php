...
@section('page-style')
        {{-- Page Css files --}}
        <link rel="stylesheet" href="{{ asset(mix('admin/css/pages/knowledge-base.css')) }}">
@endsection
@section('content')
  ...
  <div class="row search-content-info">
      ...
      <div class="card">
        <div class="card-body text-center">
          <a href="page-kb-category">
            <img src="{{ asset('admin/images/pages/graphic-1.png') }}" class="mx-auto mb-2" width="180"
    ...
    <div class="col-md-4 col-sm-6 col-12 search-content">
      <div class="card">
        <div class="card-body text-center">
          <a href="page-kb-category">
            <img src="{{ asset('admin/images/pages/graphic-2.png') }}" class="mx-auto mb-2" width="180"
              alt="knowledge-base-image">
    ...
    <div class="col-md-4 col-sm-6 col-12 search-content">
      <div class="card">
        <div class="card-body text-center">
          <a href="page-kb-category">
            <img src="{{ asset('admin/images/pages/graphic-3.png') }}" class="mx-auto mb-2" width="180"
              alt="knowledge-base-image">
            <h4>MARKETING BI</h4>
    ...
    <div class="col-md-4 col-sm-6 col-12 search-content">
      <div class="card">
        <div class="card-body text-center">
          <a href="page-kb-category">
            <img src="{{ asset('admin/images/pages/graphic-4.png') }}" class="mx-auto mb-2" width="180"
              alt="knowledge-base-image">
    ...
    <div class="col-md-4 col-sm-6 col-12 search-content">
      <div class="card">
        <div class="card-body text-center">
          <a href="page-kb-category">
            <img src="{{ asset('admin/images/pages/graphic-5.png') }}" class="mx-auto mb-2" width="180"
              alt="knowledge-base-image">
    ...
    <div class="col-md-4 col-sm-6 col-12 search-content">
      <div class="card">
        <div class="card-body text-center">
          <a href="page-kb-category">
            <img src="{{ asset('admin/images/pages/graphic-6.png') }}" class="mx-auto mb-2" width="180"
              alt="knowledge-base-image">
...
@section('page-script')
{{-- Page js files --}}
        <script src="{{ asset(mix('admin/js/scripts/pages/faq-kb.js')) }}"></script>
@endsection
