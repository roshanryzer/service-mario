        ...
        <div class="container-fluid">
            <div class="box box-block bg-white">
            	...
            	<div class="clearfix" style="margin-top: 15px;">
					<form  action="{{route('account.ride.statement.range')}}" method="GET" enctype="multipart/form-data" role="form">

						<div class="field row col-md-5">
							<label for="name" class="col-xs-4 label">Date From</label>
							<div class="col-xs-8">
								<input  class="input" type="date" name="from_date" id="from_date" required placeholder="From Date">
							</div>
						</div>

						<div class="field row col-md-5">
							<label for="email" class="col-xs-4 label">Date To</label>
							<div class="col-xs-8">
								<input  class="input" type="date" required name="to_date" id="to_date" placeholder="To Date">
							</div>
						</div>
						<div class="field row col-md-2">
