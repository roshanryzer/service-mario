...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/password/reset/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/password/reset/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/login" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/login"
);
...
```bash
curl -X POST \
    "http://servicemario.test/dispatcher/logout" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/dispatcher/password/email" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/dispatcher/password/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/password/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/password/reset/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/password/reset/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/login" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/login"
);
...
```bash
curl -X POST \
    "http://servicemario.test/fleet/logout" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/fleet/password/email" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/fleet/password/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/password/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/password/reset/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/password/reset/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/login" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/login"
);
...
```bash
curl -X POST \
    "http://servicemario.test/account/logout" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/register" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/register"
);
...
```bash
curl -X POST \
    "http://servicemario.test/account/password/email" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/account/password/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/password/reset" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/password/reset/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/password/reset/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/sendmail" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/sendmail"
);
...
```bash
curl -X POST \
    "http://servicemario.test/sendmail/verify" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/sendmail/createusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/sendmail/form" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/sendmail/form"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dashboard" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dashboard"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/hour/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/edit/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/edit/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/change/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/change/password"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/confirm/ride" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/confirm/ride"
);
...
```bash
curl -X POST \
    "http://servicemario.test/create/ride" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/cancel/ride" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/referral" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/referral"
);
...
```bash
curl -X POST \
    "http://servicemario.test/extend/trip" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/user/incoming" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/user/incoming"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/trips" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/notifications"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/lostitem/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/lostitem/1"
);
...
```bash
curl -X POST \
    "http://servicemario.test/lostitem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispute/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispute/1"
);
...
```bash
curl -X POST \
    "http://servicemario.test/dispute" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/upcoming/trips" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/upcoming/trips"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/wallet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/add/money" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/card/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/card/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/card/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/card/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/card/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/promotions" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/promotions"
);
...
```bash
curl -X POST \
    "http://servicemario.test/verify-credentials" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/payment/response" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/payment/response"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/payment/failure" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/payment/failure"
);
...
```bash
curl -X POST \
    "http://servicemario.test/paytm/response" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/payu/response" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/payu/failure" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/track/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/track/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/dashboard" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/dashboard"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/provider/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/provider/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/provider/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/provider/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/provider/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/provider/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/requests/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/requests/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/provider/1/statement" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/provider/1/statement"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/password"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/user" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/user"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/fleet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/fleet"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/range" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/range"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/today" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/today"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/monthly" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/monthly"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/account/statement/yearly" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/account/statement/yearly"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/dashboard" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/dashboard"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/review/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/review/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/approve" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/approve"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/disapprove" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/disapprove"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/request" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/request"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/document" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/document"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/document/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/document/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/document/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/document/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/provider/1/document/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/provider/1/document/1/edit"
);
...
```bash
curl -X DELETE \
    "http://servicemario.test/fleet/provider/1/service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/user/1/request" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/user/1/request"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/statement" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/statement"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/statement/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/statement/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/map" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/map"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/map/ajax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/map/ajax"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/wallet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/wallet"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/transfer" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/transfer"
);
...
```bash
curl -X POST \
    "http://servicemario.test/fleet/transfer/send" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/transfer/cancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/transfer/cancel"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/password"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/requests" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/requests"
);
...
```bash
curl -X DELETE \
    "http://servicemario.test/fleet/requests/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/requests/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/scheduled" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/scheduled"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/fleet/cards" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/fleet/cards"
);
...
```bash
curl -X POST \
    "http://servicemario.test/fleet/card/store" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/fleet/card/set" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://servicemario.test/fleet/card/destroy" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/dispatcher" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/dispatcher"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/dispatcher/trips" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/dispatcher/trips"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/dispatcher/trips/1/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/dispatcher/trips/1/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/dispatcher/users" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/dispatcher/users"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/dispatcher/providers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/dispatcher/providers"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/service"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/service/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/service/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/service/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/service/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/service/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/password"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/dispatcher/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/dispatcher/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/trips" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/trips"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/incoming" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/incoming"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/request/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/provider/request/1/rate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/earnings" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/earnings"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/upcoming" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/upcoming"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/cancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/documents" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/documents"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/documents/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/documents/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/documents/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/documents/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/documents/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/documents/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/location"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/profile/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/profile/password"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/change/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/provider/profile/available" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/wallet_transation" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/wallet_transation"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/wallet_transation/details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/transfer" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/transfer"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/transfer/send" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/transfer/cancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/transfer/cancel"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/stripe/account" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/stripe/account"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/cards" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/cards"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/card/store" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/provider/card/set" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://servicemario.test/provider/card/destroy" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/referral" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/referral"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/notifications"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/dispute/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/dispute/1"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/dispute" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/provider/waiting" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/provider/add/money" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dashboard" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dashboard"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/get/heatmap" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/get/heatmap"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/heatmap" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/heatmap"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/godseye" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/godseye"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/godseye/list" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/godseye/list"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/translation" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/translation"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/fare" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/fare"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/logs"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/download/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/download/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatcher" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatcher"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatcher/trips" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatcher/trips"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatcher/cancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatcher/cancel"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatcher/trips/1/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatcher/trips/1/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatcher/users" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatcher/users"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatcher/providers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatcher/providers"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/user" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/user"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/user/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/user/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/user/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/user/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/user/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatch-manager" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatch-manager"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatch-manager/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatch-manager/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatch-manager/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatch-manager/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispatch-manager/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispatch-manager/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/account-manager" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/account-manager"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/account-manager/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/account-manager/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/account-manager/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/account-manager/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/account-manager/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/account-manager/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute-manager" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute-manager"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute-manager/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute-manager/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute-manager/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute-manager/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute-manager/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute-manager/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/fleet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/fleet"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/fleet/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/fleet/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/fleet/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/fleet/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/fleet/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/fleet/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/document" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/document"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/document/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/document/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/document/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/document/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/document/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/document/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/service"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/service/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/service/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/service/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/service/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/service/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/promocode" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/promocode"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/promocode/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/promocode/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/promocode/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/promocode/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/promocode/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/promocode/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/role" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/role"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/role/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/role/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/role/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/role/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/role/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/role/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/sub-admins" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/sub-admins"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/sub-admins/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/sub-admins/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/sub-admins/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/sub-admins/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/sub-admins/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/sub-admins/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/review/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/review/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/ajax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/ajax"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/approve" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/approve"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/disapprove" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/disapprove"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/request" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/request"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/statement" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/statement"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/password"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/document" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/document"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/document/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/document/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/document/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/document/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/provider/1/document/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/provider/1/document/1/edit"
);
...
```bash
curl -X DELETE \
    "http://servicemario.test/admin/provider/1/service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/review/user" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/review/user"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/user/1/request" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/user/1/request"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/map" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/map"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/map/ajax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/map/ajax"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/site/settings" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/site/settings"
);
...
```bash
curl -X POST \
    "http://servicemario.test/admin/settings/store" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/settings/payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/settings/payment"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/profile"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/password"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/payment"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dbbackup" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dbbackup"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/user" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/user"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/fleet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/fleet"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/range" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/range"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/today" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/today"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/monthly" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/monthly"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/yearly" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/yearly"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement/1/statement" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement/1/statement"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement_user/1/statement_user" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement_user/1/statement_user"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/statement_fleet/1/statement_fleet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/statement_fleet/1/statement_fleet"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transactions" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transactions"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transfer/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transfer/provider"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transfer/fleet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transfer/fleet"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transfer/1/approve" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transfer/1/approve"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transfer/cancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transfer/cancel"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transfer/1/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transfer/1/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/transfer/search" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/transfer/search"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/users/search" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/users/search"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/users/provider" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/users/provider"
);
...
```bash
curl -X POST \
    "http://servicemario.test/admin/ride/search" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/admin/transfer/store" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/reason" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/reason"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/reason/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/reason/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/reason/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/reason/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/reason/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/reason/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/peakhour" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/peakhour"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/peakhour/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/peakhour/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/peakhour/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/peakhour/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/peakhour/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/peakhour/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/dispute/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/dispute/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/disputeusers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/disputeusers"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/disputelist" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/disputelist"
);
...
```bash
curl -X POST \
    "http://servicemario.test/admin/disputeuserstore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/admin/disputeuserupdate1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/disputeusercreate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/disputeusercreate"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/disputeuseredit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/disputeuseredit/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/notification" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/notification"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/notification/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/notification/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/notification/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/notification/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/notification/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/notification/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/lostitem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/lostitem"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/lostitem/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/lostitem/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/lostitem/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/lostitem/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/lostitem/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/lostitem/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/help" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/help"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/send/push" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/send/push"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/pages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/pages"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/pages/search/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/pages/search/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/requests" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/requests"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/requests/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/requests/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/requests/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/requests/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/requests/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/requests/1/edit"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/scheduled" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/scheduled"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/admin/push" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/admin/push"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/settings" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/settings"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/register" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/oauth/token" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/logout" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/verify" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/auth/facebook" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/auth/google" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/forgot/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/reset/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/refresh/token" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/refresh/token"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/update-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/get-location"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/remove-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/remove-location"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/add/money" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/payment-log" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/braintree/token" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/braintree/token"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/payu/response" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/payu/failure" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/payment/success" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/payment/success"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/profile" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/profile"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/profile/password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/profile/location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/profile/language" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/profile/available" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/profile/documents" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/profile/documents"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/profile/documents/store" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/profile/details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/providercard" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/providercard"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/providercard/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/providercard/create"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/providercard/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/providercard/1"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/providercard/1/edit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/providercard/1/edit"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/chat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/target" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/target"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/trip" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/trip"
);
...
```bash
curl -X PUT \
    "http://servicemario.test/api/provider/trip/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/cancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/summary" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/help" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/help"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/wallettransaction" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/wallettransaction"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/wallettransaction/details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/wallettransaction/details"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/transferlist" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/transferlist"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/requestamount" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/requestcancel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/requestcancel"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/waiting" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/trip/1/rate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/trip/1/calculate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/requests/rides" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/requests/instant/ride" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/requests/upcoming" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/requests/upcoming"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/requests/history" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/requests/history"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/requests/history/details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/requests/history/details"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/requests/upcoming/details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/requests/upcoming/details"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/test/push" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/reasons" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/reasons"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/api/provider/notifications/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/api/provider/notifications/1"
);
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/dispute-list" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/dispute" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/drop-item" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/api/provider/verify-credentials" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X POST \
    "http://servicemario.test/save-subscription/1/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/payment/response" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/payment/response"
);
...
```bash
curl -X GET \
    -G "http://servicemario.test/provider/payment/failure" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://servicemario.test/provider/payment/failure"
);
...
```bash
curl -X POST \
    "http://servicemario.test/provider/paytm/response" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
