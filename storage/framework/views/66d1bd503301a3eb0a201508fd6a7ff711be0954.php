        ...
        <div class="box box-block bg-white">
            ...
            <form  action="<?php echo e(route('admin.send.push')); ?>" method="POST" role="form" id="create_push">
                ...
                <div class="field">
                    ...
                    <div class="select control">
                        <select class="select" name="send_to" onchange="switch_send(this.value)">
                            <option value="ALL">All <?php echo app('translator')->getFromJson('admin.user'); ?>s and <?php echo app('translator')->getFromJson('admin.provider'); ?>s</option>
                ...
                <div class="field row" id="for_users" style="display: none;">
                    <label class="label">Conditions of <?php echo app('translator')->getFromJson('admin.user'); ?></label>
                    ...
                    <div class="select col-xs-5" id="user_active" style="display: none;">
                ...
                <div class="field row" id="for_providers" style="display: none;">
                    <label class="label">Conditions of <?php echo app('translator')->getFromJson('admin.provider'); ?>s</label>
                    <div class="select col-xs-5">
                    ...
                    <div class="select col-xs-5" id="provider_active" style="display: none;">
