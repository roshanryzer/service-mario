...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?><?php echo e(Setting::get('site_title', 'Service Mario')); ?></title>
            ...
            <div class="full-page-bg-inner">
                <div class="row no-margin">
                    <div class="col-md-6 log-left">
                        ...
                        <h2><?php echo e(Setting::get('site_title','Service Mario')); ?> needs partners like you.</h2>
                        <p>Partner with <?php echo e(Setting::get('site_title','Service Mario')); ?> and earn great money as an independent contractor. Get paid weekly just for helping our community of Partners get to Services lead around town. Be your own boss and get paid in fares for Services on your own schedule.</p>
                    </div>
