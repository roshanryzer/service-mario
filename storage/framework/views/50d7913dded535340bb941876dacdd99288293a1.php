                        ...
                        <div class="column">
                            <form action="<?php echo e(route('admin.settings.store')); ?>" method="POST"
                                ...
                                <div class="field">
                                    ...
                                    <div class="">
                                        <input class="input" type="text"
                                            value="<?php echo e(config('constants.site_title', 'Service Mario')); ?>" name="site_title"
                                ...
                                <div class="field">
                                    ...
                                    <div class="">
                                        <input class="input" type="text"
                                            value="<?php echo e(config('constants.site_copyright', '&copy; '.date('Y').' Service Mario')); ?>"
                            ...
                            <form action="<?php echo e(route('admin.settings.store')); ?>" method="POST"
                                ...
                                <div class="field">
                                    <label for="base_price" class="column label"><?php echo app('translator')->getFromJson('admin.payment.currency'); ?>
                                        ( <strong><?php echo e(config('constants.currency', 'रु')); ?> </strong>)
                                    </label>
                                    <div class="select">
...
<!--                                            <option <?php if(config('constants.currency')=="RM" ): ?> selected <?php endif; ?> value="RM">
                                            ...
                                            <option <?php if(config('constants.currency')=="रु" ): ?> selected <?php endif; ?> value="रु">
