        ...
        <div class="box box-block bg-white">
            ...
            <form  action="<?php echo e(route('admin.notification.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="form-control date" autocomplete="off"  type="date" value="<?php echo e(old('expiry_date')); ?>" name="expiry_date" required id="expiry_date" placeholder="<?php echo app('translator')->getFromJson('admin.notification.notify_expiry'); ?>">
                    </div>
                </div>
