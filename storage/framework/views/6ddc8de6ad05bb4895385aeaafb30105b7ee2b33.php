...
<title><?php echo e(config('constants.site_title', 'Service Marios')); ?> - <?php echo $__env->yieldContent('title'); ?> - Admin Dashboard</title>
...
<link rel="stylesheet" href="<?php echo e(asset('admin/css/colors.css')); ?>"/>
<link rel="stylesheet" href="<?php echo e(asset('admin/css/components.css')); ?>"/>
<link rel="stylesheet" href="<?php echo e(asset('admin/css/themes/dark-layout.css')); ?>"/>
<link rel="stylesheet" href="<?php echo e(asset('admin/css/themes/dark-layout.css')); ?>"/>
...
class="button is-default is-hidden-mobile	is-pulled-right	"><?php echo app('translator')->getFromJson('admin.back'); ?></a>
<?php endif; ?>
</div>
</div>
