<?php $__env->startSection('content'); ?>
                    ...
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="<?php echo e(url('provider/login')); ?>">
                                <h3>Quer ser <?php echo app('translator')->getFromJson('admin.provider'); ?>?</h3>
                                <h5>CADASTRE-SE <i class="fa fa-chevron-right"></i></h5>
                            </a>
                        </div>
                    </div>
    ...
    <div class="row white-section pad-60 no-margin">
        <div class="container ">
            ...
            <div class="column content-block small">
                ...
                <p><?php echo e(config('constants.site_title', 'Moob')); ?> é a maneira mais inteligente de se locomover. Um toque e um carro ou moto vai até você. Seu <?php echo app('translator')->getFromJson('admin.provider'); ?> sabe exatamente para onde ir. E você pode pagar com dinheiro ou cartão.</p>
            </div>
        </div>
            ...
            <div class="column content-block small">
                ...
                <div class="title-divider"></div>
                <p>Avalie seu <?php echo app('translator')->getFromJson('admin.provider'); ?> e forneça comentários anônimos sobre sua viagem. Sua entrada nos ajuda a tornar cada passeio uma experiência de 5 estrelas.</p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="column full-img text-center" style="background-image: url(<?php echo e(asset('asset/img/safty-bg.jpg')); ?>);"> 
