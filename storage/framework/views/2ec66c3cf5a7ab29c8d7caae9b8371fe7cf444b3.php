...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="column" style="height:50px;color:red;">
            ...
            <a href="<?php echo e(route('admin.sub-admins.create')); ?>" style="margin-left: 1em;" class="button is-link pull-right"><i class="fa fa-plus"></i> Add Admin</a>
            <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo e(route('admin.sub-admins.destroy', $user->id)); ?>" method="POST">
                                ...
                                <a href="<?php echo e(route('admin.sub-admins.edit', $user->id)); ?>" class="button is-info"><i class="fa fa-pencil"></i> <?php echo app('translator')->getFromJson('admin.edit'); ?></a>
                                <?php endif; ?>
