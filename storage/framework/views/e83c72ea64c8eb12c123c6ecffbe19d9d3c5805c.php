    ...
    <div class="full-page-bg-inner">
        <div class="columns no-margin">
            <div class="col-md-6 log-left">
                ...
                <p>Welcome to <?php echo e(Setting::get('site_title','Service Mario')); ?>, the easiest way to get around at the tap of a
                    button.</p>
            </div>
            <div class="col-md-6 log-right">
                <div class="login-box-outer">
                    ...
                    <div class="log-copy">
                        <p class="no-margin">&copy;<?php echo e(date('Y')); ?> <?php echo e(Setting::get('site_title','Service Mario')); ?></p>
                    </div>
                </div>
            </div>
        </div>
