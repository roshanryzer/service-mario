    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form  action="<?php echo e(route('admin.role.store')); ?>" method="POST" role="form">
                ...
                <div class="field">
                    <label for="name" class="column label"><?php echo app('translator')->getFromJson('admin.roles.role_name'); ?></label>
                    <div class="control">
                ...
                <div class="field">
                    <label for="permission" class="column label"><?php echo app('translator')->getFromJson('admin.permissions'); ?></label>
                    <div class="control">
                        <?php $val = ""; ?>
