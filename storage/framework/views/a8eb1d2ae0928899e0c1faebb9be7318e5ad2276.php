...
<script>
    ...
    function initMap() {
        ...
        div.innerHTML = '<img src="' + mapIcons['user'] + '"> ' + '<?php echo app('translator')->getFromJson('admin.user'); ?>';
        legend.appendChild(div);

        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['offline'] + '"> ' + '<?php echo app('translator')->getFromJson('admin.provider'); ?> in Rest';
        legend.appendChild(div);
        
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['active'] + '"> ' + '<?php echo app('translator')->getFromJson('admin.provider'); ?> Available';
        legend.appendChild(div);
        
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['unactivated'] + '"> ' + '<?php echo app('translator')->getFromJson('admin.provider'); ?> <?php echo app('translator')->getFromJson('admin.inactive'); ?>';
        legend.appendChild(div);
