...
<div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <p style = "color: red;"> <?php echo e(config ('constants.booking_prefix', '')); ?> - Request Transactions, PSET - Transaction from <?php echo app('translator')->getFromJson('admin.provider'); ?>, URC - Refills from <?php echo app('translator')->getFromJson('admin.user'); ?> </p></div>
