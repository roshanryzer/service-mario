    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <a href="<?php echo e(route('admin.promocode.create')); ?>" style="margin-left: 1em;" class="button is-link pull-right column is-2 is-offset"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('admin.promocode.add_promocode'); ?></a>
                <?php endif; ?>
                </div>
