            ...
            <aside class="menu ">
                ...
                <ul class="menu-list">
                            ...
                            <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                                <div class="dropdown-content">
                                    <div class="dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="<?php echo e(route('admin.dispute.index')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.dispute_type'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.userdisputes')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.dispute_request'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('heat-map')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.map.index')); ?>"
                               class="<?php echo e(Request::segment(2) === 'map' ? 'is-active has-background-primary' : null); ?> has-text-black">
                                <i class="ti-map-alt"></i>
                                <?php echo app('translator')->getFromJson('admin.include.map'); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.heatmap')); ?>"
                               class="<?php echo e(Request::segment(2) === 'heatmap' ? 'is-active has-background-primary' : null); ?> has-text-black">
                                <i class="ti-map"></i>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('service-types-list')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('admin.service.index')); ?>">
                                                        <?php echo app('translator')->getFromJson('admin.include.list_service_types'); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('peak-hour-list')): ?>
                                                <li>
                                                    <a href="<?php echo e(route('admin.peakhour.index')); ?>">
                                                        <?php echo app('translator')->getFromJson('admin.include.peakhour'); ?></a>
                                                </li>
                                                <?php endif; ?>
                                        </ul>
                                    </div>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('documents-list')): ?>
                        <li>
                            <a class="has-text-black <?php echo e(Request::segment(2) === 'document' ? 'is-active has-background-primary' : null); ?>"
                               href="<?php echo e(route('admin.document.index')); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notification-list')): ?>
                        <li>
                            <a class="has-text-black <?php echo e(Request::segment(2) === 'notification' ? 'is-active has-background-primary' : null); ?>"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cancel-reasons-list')): ?>
                        <li>
                            <a class="has-text-black <?php echo e(Request::segment(2) === 'reason' ? 'is-active has-background-primary' : null); ?>"
                               href="<?php echo e(route('admin.reason.index')); ?>">
                    ...
                    <?php endif; ?>
                    <li>
                        <a class="has-text-black <?php echo e(Request::segment(2) === 'banner' ? 'is-active has-background-primary' : null); ?>"
                    ...
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.members'); ?></li>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-list')): ?>
                                            <li>
                                                <a href="<?php echo e(route('admin.role.index')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.role_types'); ?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sub-admin-list')): ?>
                                            <li>
                                                <a href="<?php echo e(route('admin.sub-admins.index')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.sub_admins'); ?></a>
                                            </li>
                                            <?php endif; ?>
                                    </div>
                                </div>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.user.index')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'user' ? ' is-active has-background-primary' : null); ?>">
                                <i class="fa fa-user" aria-hidden="true"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('provider-list')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.provider.index')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'provider' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dispatcher-list')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.dispatch-manager.index')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'dispatch-manager' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('account-manager-list')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.account-manager.index')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'account-manager' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dispute-manager-list')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.dispute-manager.index')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'dispute-manager' ? ' is-active has-background-primary' : null); ?>">
                                <img src="<?php echo e(asset('asset/img/account.png')); ?>" style="filter: invert(100%);">
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.accounts'); ?></li>
                    <?php endif; ?>
                            ...
                            <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                                <div class="dropdown-content">
                                    <div class="dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="<?php echo e(route('admin.ride.statement')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.overall_ride_statments'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.ride.statement.provider')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.provider_statement'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.ride.statement.user')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.user_statement'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.ride.statement.today')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.daily_statement'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.ride.statement.monthly')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.monthly_statement'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.ride.statement.yearly')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.yearly_statement'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                                <div class="dropdown-content">
                                    <div class="dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="<?php echo e(route('admin.providertransfer')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.provider_request'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.transactions')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.all_transaction'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.details'); ?></li>
                    <?php endif; ?>
                            ...
                            <div class="dropdown-menu" id="dropdown-menu4" role="menu">
                                <div class="dropdown-content">
                                    <div class="dropdown-item">
                                        <ul>
                                            <li>
                                                <a href="<?php echo e(route('admin.user.review')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.user_ratings'); ?></a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('admin.provider.review')); ?>">
                                                    <?php echo app('translator')->getFromJson('admin.include.provider_ratings'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.rides'); ?></li>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.offer'); ?></li>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('promocodes-list')): ?>
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.promocode.index')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'promocode' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.payment_details'); ?></li>
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('admin.stripe.index')); ?>"
                           class="has-text-black <?php echo e(Request::segment(2) === 'stripe' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('payment-history')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.payment')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'payment' ? ' is-active has-background-primary' : null); ?>">
                                <i class="fa fa-money" aria-hidden="true"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('payment-settings')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.settings.payment')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'settings' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.settings'); ?></li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('site-settings')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.settings')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'site' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.others'); ?></li>
                    <?php endif; ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cms-pages')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.cmspages')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'pages' ? ' is-active has-background-primary' : null); ?>">
                                <i class="ti-file"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('custom-push')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.push')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'send' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if(auth()->check() && auth()->user()->hasRole('ADMIN')): ?>
                    <li class="menu-title">
                        <?php echo app('translator')->getFromJson('admin.include.account'); ?></li>
                    <?php endif; ?>

                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('account-settings')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.profile')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'profile' ? ' is-active has-background-primary' : null); ?>">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('change-password')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.password')); ?>"
                               class="has-text-black <?php echo e(Request::segment(2) === 'password' ? ' is-active has-background-primary' : null); ?>">
