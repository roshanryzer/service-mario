    ...
    public function settings_store(Request $request) {
        ...
        if (!file_exists($config)) {
            ...
            $data = "<?php 
				...
				return array(
					'site_title' => 'Service Mario',
					'site_logo' => '',
					'site_email_logo' => '',
					'site_icon' => '',
					'site_copyright' => '© Service Mario',
...
');
    ...
    public function help() {
        try {
            $str = '{"content":"<p>We&#39;d like to thank you for deciding to use our script. We enjoyed creating it and hope you enjoy using it to achieve your goals :)&nbsp;If you want something changed to suit&nbsp;your venture&#39;s needs better, drop us a line: info@thinkinservicemario.com<\/p>\r\n"}';
